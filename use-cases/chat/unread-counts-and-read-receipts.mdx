...
<Steps>
  ...
  <Step title="Reset unread count when the channel opens">
    ...
    async function onChannelOpen(channel: Amity.Channel) {
      await channel.markAsRead();
    }
    ```
  </Step>
...
<AccordionGroup>
  <Accordion title="Push notifications on unread" icon="bell">
    ...
    → [Push Notifications Setup](/social-plus-sdk/core-concepts/realtime-communication/push-notifications/register-and-unregister-push-notifications-on-a-device)
  </Accordion>
