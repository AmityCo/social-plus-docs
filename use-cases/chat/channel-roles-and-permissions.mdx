...
- Role assignment and removal (`channel-moderator`, custom roles)
- Member list filtered by role
- Permission-gated UI (show moderation controls only to moderators)
...
<CardGroup cols={3}>
  ...
  <Card title="Build a Group Chat" href="/use-cases/chat/build-a-group-chat" icon="users">
    Full group chat trail where roles and permissions matter most.
  </Card>
