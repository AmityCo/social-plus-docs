...
- Emoji reactions on messages with live-updating counts
- Threaded reply conversations anchored to a parent message
- Toggle reactions (add/remove by name)
- Reaction summary query per message
