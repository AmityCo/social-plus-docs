...
- Image, audio, video, and file message sending
- Upload-first flow with progress tracking
- Custom message type for link previews, polls, or any structured data
- Thumbnail and inline preview rendering
...
<Steps>
  <Step title="Upload the file first">
    ...
    → [File Upload](/social-plus-sdk/core-concepts/content-handling/file-handling)
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="Build a 1:1 Chat" href="/use-cases/chat/build-a-1on1-chat" icon="comments">
    Full 1:1 trail showing where rich media fits in the DM flow.
  </Card>
</CardGroup>
