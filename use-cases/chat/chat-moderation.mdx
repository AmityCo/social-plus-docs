...
- Temporary mutes to slow down disruptive users without removing them
- Channel bans that remove users and optionally delete their messages
- Message deletion for individual harmful content
- Global ban integration for repeat offenders across your network
- AI moderation configuration (Admin Console)
...
<Steps>
  <Step title="Mute a user temporarily">
    ...
    → [Mute / Unmute](/social-plus-sdk/chat/moderation-safety/member-management/mute-member)
  </Step>
  <Step title="Ban and unban users from a channel">
    ...
    → [Ban / Unban](/social-plus-sdk/chat/moderation-safety/member-management/ban-unban-user-from-channel)
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="Build a Group Chat" href="/use-cases/chat/build-a-group-chat" icon="users">
    Complete group chat trail from creation to moderation.
  </Card>
