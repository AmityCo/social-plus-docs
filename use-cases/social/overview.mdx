...
<Tip>
**Not sure where to start?** See the [Start by App Type](/use-cases/overview#start-by-app-type) section on the main Guides page for recommended build orders by app category (social, marketplace, gaming, livestream, etc.).
</Tip>
