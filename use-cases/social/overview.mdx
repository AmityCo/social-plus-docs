...
<Card
  title="🚀 New: Build a Complete Social App — Guided Trail"
  icon="map"
  href="/use-cases/social/build-a-complete-social-app"
>
  Follow 6 phases from user onboarding → feeds → content → engagement → communities → notifications. Build a fully-featured social app in ~2.5 hours.
</Card>
