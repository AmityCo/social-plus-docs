...
<Frame caption="Admin Console — Livestream management page showing active and past streams">
  <img src="/images/analytics-and-moderation/console-live-stream-management.png" alt="Admin Console — Livestream management" />
</Frame>
...
<Tip>
**Dive deeper**: [Video SDK Reference](/social-plus-sdk/video-new/overview) has full parameter tables, method signatures, and platform-specific details for every API used in this guide.
</Tip>
