...
- Video SDK configured → [Video Getting Started](/social-plus-sdk/video-new/getting-started/)
- LiveKit client SDK installed (`livekit-client` npm package)
- A `communityId` to host the broadcast room
