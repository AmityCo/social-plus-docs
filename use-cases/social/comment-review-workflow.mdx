...
<Steps>
  <Step title="Turn on review for a community">
    ...
    Full reference → [Require Review for a Community's Comments](/social-plus-sdk/social/content-management/comments/moderation/comment-review#require-review-for-a-communitys-comments)
  </Step>
  ...
  <Step title="Keep the thread and counts correct">
    ...
    Full reference → [Receive Approvals in Realtime](/social-plus-sdk/social/content-management/comments/moderation/comment-review#receive-approvals-in-realtime)
  </Step>
