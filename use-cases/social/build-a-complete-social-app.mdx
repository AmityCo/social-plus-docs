...
description: "Follow this guided trail to build a fully-featured social app from zero — user onboarding through notifications — in 6 phases."
---

# Build a Complete Social App
