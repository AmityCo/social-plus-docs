...
- SDK installed with authenticated users
- Admin Console access (for moderator configuration)
- A server endpoint to receive webhook events (for automation)
...
Flagged content and AI-held content lands in the Admin Console review queues.
