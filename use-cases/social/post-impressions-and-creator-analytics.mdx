...
<CardGroup cols={4}>
  <Card title="Impression Recording" icon="eye">
    Call `markAsViewed()` at the right moment so every scroll through a feed accumulates accurate view data
  </Card>
  <Card title="Reach Counter" icon="users">
    Read `post.reach` to show creators how many unique people their content reached
  </Card>
  <Card title="Viewed Users List" icon="list-ul">
    Paginate through every user who viewed a post — useful for audience insights and "seen by" UIs
  </Card>
  <Card title="Creator Dashboard" icon="chart-line">
    Combine impressions, reach, reactions, and comments into a single creator analytics view
  </Card>
</CardGroup>
