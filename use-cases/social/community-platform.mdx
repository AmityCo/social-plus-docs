...
erDiagram
    COMMUNITY {
        ...
        string displayName
        boolean isPublic
        string postSetting "ANYONE | ADMIN_REVIEW | ADMIN_ONLY"
        int membersCount
        string[] categoryIds
    }
    CATEGORY {
    ...
    POST {
        ...
        string communityId FK
        string creatorId FK
        string reviewStatus "published | reviewing | declined"
    }
    COMMUNITY ||--o{ MEMBER : "has members"
    COMMUNITY ||--o{ POST : "contains"
    COMMUNITY }o--o{ CATEGORY : "tagged with"
    MEMBER }o--|| USER : "is a"
```
...
<Frame caption="Admin Console — Community management showing member lists, post queues, and settings">
  <img src="/images/create-commupublic(1).png" alt="Admin Console — Community management" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Admin Console: community management" icon="shield">
    ...
    → [Admin Console: Social Management](/analytics-and-moderation/console/social-management/README)
  </Accordion>
...
<Tip>
**Dive deeper**: [Communities API Reference](/social-plus-sdk/social/communities-spaces/overview) has full parameter tables, method signatures, and platform-specific details for every API used in this guide.
</Tip>
