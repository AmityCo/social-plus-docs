...
<Steps>
  <Step title="Community Platform" icon="users">
    ...
    → [Open guide](/use-cases/social/livestream/go-live-and-room-management) · `~30 min` · <span style={{color:"#dc2626",background:"#fee2e2",padding:"2px 8px",borderRadius:"12px",fontSize:"0.85em",fontWeight:"500"}}>Advanced</span>
  </Step>
  <Step title="Roles, Permissions & Governance" icon="user-shield">
