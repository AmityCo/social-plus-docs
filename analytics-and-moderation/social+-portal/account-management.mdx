...
description: "Comprehensive team management and access control in Social+ Portal with role-based permissions, user invitations, and collaborative workspace administration."
---

# Account Management

Manage your organization's Social+ Portal access with comprehensive team management capabilities. Control user permissions, facilitate collaboration, and maintain security through role-based access control and user management features.

<Info>
Account Management enables teams of up to 50 users to collaborate effectively on Social+ applications with granular permission controls and secure access management.
</Info>
    ...
    <AccordionGroup>
      <Accordion title="Application Management">
        **Application Lifecycle:**
        - **Create**: Set up new Social+ applications
  ...
  <Tab title="User Invitations">
    ...
    <Steps>
      <Step title="Access Member Management">
        Navigate to **Account** → **Manage Members** in the Social+ Portal
      </Step>
