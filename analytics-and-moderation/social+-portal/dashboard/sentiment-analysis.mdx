...
Worked example — 14 positive, 21 negative, and 148 neutral mentions (183 total):

```
(14 − 21) / 183 × 100 = −3.8  →  displayed as −4
```
...
<AccordionGroup>
  <Accordion title="How neutral mentions affect the score" icon="scale-balanced">
    ...
    A small negative score such as −4 therefore means **"essentially balanced, leaning very slightly negative"** — not "4 out of 100".
  </Accordion>
  ...
  <Accordion title="Comparison against the prior period" icon="arrow-right-arrow-left">
    The comparison period is the window of **equal length immediately preceding** your selection. Selecting 1–22 August (22 days) compares against 10–31 July (the previous 22 days).

    The change is shown in **points on the −100 to +100 scale**, not as a percentage — a change of *−63 pts* means the earlier period scored roughly +59.
