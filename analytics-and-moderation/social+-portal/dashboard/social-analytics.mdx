...
<Info>
Filter analytics to a specific community to isolate engagement, growth, and content patterns—helping you diagnose whether trends are platform-wide or community-specific.
</Info>

### Why Filter by Community?

- Identify which communities drive or drag overall metrics
- Diagnose localized issues vs platform-wide trends
- Compare individual community performance against baseline

<Warning>
Widget **Top Communities** and **Reach and Impression** will always show data for all communities, even when a specific community is selected in the filter.
</Warning>

### How to Apply

<Steps>
  <Step title="Select Community">Open the community dropdown and choose one community from the list.</Step>
  <Step title="Review Metrics">Compare filtered metrics (posts, engagement rate, net growth) against your unfiltered baseline.</Step>
  <Step title="Take Action">If metrics diverge significantly, investigate community-specific content, moderation, or member composition.</Step>
</Steps>

<Note>
Analytics shows data for **one community at a time**. To compare multiple communities, filter each separately and record results.
</Note>
