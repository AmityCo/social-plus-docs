...
<Info>
The Product Catalogue in the social.plus Console allows administrators to manage a centralized product database. Products added here can be tagged in **posts** — in the post text or directly on image and video attachments — and in **livestream posts**, enabling social commerce experiences and product discovery within your application.
</Info>
...
The Product Catalogue provides a centralized dashboard for uploading, managing, and previewing products that can be tagged in community content. This enables social commerce workflows where users can discover and engage with products directly within posts and livestream posts.
