---
title: "Getting Started with Social+ Console"
description: "Step-by-step guide to accessing and setting up your Social+ Console for the first time"
---

# Getting Started with Social+ Console

Get up and running with your Social+ Console in minutes. This guide covers everything you need to know for initial setup and basic configuration.

## Prerequisites

Before accessing your console, ensure you have:

- An active [Social+ Portal](https://portal.amity.co) account
- At least one Social+ application created in your portal
- Administrative access to your organization's Social+ account

## Accessing Your Console

<Steps>
  <Step title="Login to Social+ Portal">
  ...
  <Step title="Select Your Application">
    ...
    ![My Applications Screen](<../../../.gitbook/assets/Screenshot (901).png>)
  </Step>
  
  <Step title="Open Console">
    Click the "**Go to Console**" button for your selected application. This will open the Social+ Console in a new tab.
  </Step>
...
<Steps>
  ...
  <Step title="Copy API Key">
    ...
    <figure><img src="../../../.gitbook/assets/Screenshot 2567-05-10 at 13.35.35.png" alt="API Key Location" /><figcaption>API Key in Settings > Security</figcaption></figure>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Explore Moderation" icon="shield" href="../moderation/overview">
    Learn advanced content moderation techniques and workflows
  </Card>
  <Card title="Review Analytics" icon="chart-line" href="../analytics/overview">
    Understand your community metrics and engagement patterns
  </Card>
  <Card title="Configure Settings" icon="cog" href="../settings">
    Dive deeper into security, notifications, and integrations
  </Card>
  <Card title="Use APIs" icon="code" href="../../social+-apis-and-services/overview">
    Implement programmatic administration with Social+ APIs
  </Card>
</CardGroup>
...
<AccordionGroup>
  <Accordion title="Can't Access Console">
    - Verify you're logged into the correct Social+ Portal account
