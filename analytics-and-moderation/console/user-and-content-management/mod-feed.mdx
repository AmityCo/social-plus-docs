...
<iframe width="720" height="405" src="https://www.youtube.com/embed/uJ_i8utLnBE?si=6Js8nkLmmmHbYF6Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<CardGroup cols={3}>
  <Card title="Triage" icon="triangle">
...
<Steps>
  <Step title="Open Moderation Section">
    Sidebar → Moderation → Moderation Feed.
  </Step>
  
  <Step title="Choose Tab">
...
<Tabs>
  ...
  <Tab title="Reviewed">
    Historical ledger of resolved items (deleted or flags cleared) with moderator name, action, timestamp, and additional filters for attribution and action type.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="AI Assistance">
    Use AI mod reasons to pre-group similar infractions → Bulk evaluate for consistency.
  </Tab>
  
  <Tab title="Attachment Focus">
    Advanced Filter → Attachments: Videos / Files → Prioritize for manual safety review.
  </Tab>
  
  <Tab title="Backlog Reduction">
    Sort by Oldest first → Work sequentially → Move to Latest first for fresh queue scan.
  </Tab>
  
  <Tab title="Moderator Audit">
    Reviewed tab → Filter by Moderator Name → Spot consistency gaps.
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="User History" icon="user" href="/analytics-and-moderation/console/user-and-content-management/user-social-history">
    Deep dive individual users
  </Card>
  
  <Card title="Posts Management" icon="message-square" href="/analytics-and-moderation/console/social-management/social-management/posts">
    Contextual content review
  </Card>
</CardGroup>

<CardGroup cols={2}>
  <Card title="Channel Management" icon="layers" href="/analytics-and-moderation/console/chat-management/channel-management">
    Moderate chat spaces
  </Card>
