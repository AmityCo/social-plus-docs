...
<Steps>
  ...
  <Step title="Confirm">
    Select **Mute user**. The Console confirms with "&lbrace;name&rbrace; has been muted".
  </Step>
</Steps>
...
Open the same actions menu and choose **Unmute globally**, then confirm with **Unmute**. The Console confirms with "&lbrace;name&rbrace; is no longer muted", and the user can post, comment, react and send messages again straight away.
