...
<CardGroup cols={2}>
  <Card title="Moderation Feed" icon="inbox" href="../user-and-content-management/mod-feed">Central triage & audit</Card>
  <Card title="User History" icon="user" href="../user-and-content-management/user-social-history">Broadcaster behavioral context</Card>
</CardGroup>
