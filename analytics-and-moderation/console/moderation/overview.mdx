...
<CardGroup cols={3}>
  ...
  <Card title="Manual Review" icon="eye" href="manual-review">
    Prioritized queues, decisions, escalation & audit trails
  </Card>
  <Card title="User Actions" icon="user-shield" href="users">
  ...
  <Card title="Reporting & Analytics" icon="chart-bar" href="../analytics/moderation-analytics">
    Volume, SLA, effectiveness & community health metrics
  </Card>
