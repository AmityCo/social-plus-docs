...
<iframe width="720" height="405" src="https://www.youtube.com/embed/XH9fVIktWP4?si=DCvSwM1SRixHYKk8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<CardGroup cols={3}>
  <Card title="AI Detection" icon="robot" href="/analytics-and-moderation/console/ai-content-moderation">
    Automated text / image / video analysis with confidence tuning
  </Card>
  <Card title="Manual Review" icon="eye" href="/analytics-and-moderation/console/moderation/overview#structured-review-queues">
  ...
  <Card title="Analytics Export" icon="chart-bar" href="/analytics-and-moderation/social+-portal/dashboard/raw-data-export">
    Raw metrics export for BI & policy tuning
  </Card>
  <Card title="Policy Configuration" icon="gear" href="/analytics-and-moderation/console/ai-content-moderation#configuration">
...
<CardGroup cols={3}>
  <Card title="Webhook" icon="code" href="/analytics-and-moderation/social+-apis-and-services/webhook-event">
    Live events for content status, enforcement & appeals
  </Card>
  <Card title="API Endpoints" icon="cloud" href="/analytics-and-moderation/social+-apis-and-services/README">
    Programmatic moderation & bulk operations
  </Card>
  <Card title="Analytics Export" icon="file-export" href="/analytics-and-moderation/social+-portal/dashboard/raw-data-export">
