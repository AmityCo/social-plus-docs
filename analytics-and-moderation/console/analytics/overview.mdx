...
Gain deep insights into your community's health and growth with Social+ Console's comprehensive analytics. Track user engagement, content performance, moderation effectiveness, and business metrics to make data-driven decisions.
...
<CardGroup cols={2}>
  ...
  <Card title="Moderation Analytics" icon="shield-check" href="moderation-analytics">
    Review moderation effectiveness, flagging patterns, and safety metrics
  </Card>
