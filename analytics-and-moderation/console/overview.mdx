...
<Tabs>
  <Tab title="Content & Safety">
    <CardGroup cols={2}>
      ...
      <Card title="Community Safety" icon="shield-heart" href="moderation/roles-and-privileges">
        Community safety tools, role management, and privilege control systems
      </Card>
  <Card title="Livestream Moderation" icon="video" href="moderation/livestream-moderation">
  ...
  <Tab title="User Management">
    <CardGroup cols={2}>
      ...
      <Card title="User History Tracking" icon="rectangle-history" href="user-and-content-management/user-social-history">
  ...
  <Tab title="Community Features">
    <CardGroup cols={2}>
      <Card title="Community Management" icon="comments" href="social-management">
