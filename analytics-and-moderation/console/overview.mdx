---
title: "Overview"
description: "Comprehensive administrative dashboard for managing Social+ applications, monitoring community health, and moderating content through an intuitive web interface"
---

<Info>
The Social+ Console is your comprehensive administrative dashboard for managing Social+ applications. Monitor community health, moderate content, manage users, and configure settings through an intuitive web interface designed for maximum efficiency and control.
</Info>
...
<Steps>
  <Step title="Access Your Console">
    Navigate to your application in [Social+ Portal](https://portal.amity.co) and click **"Go to Console"** to access your administrative dashboard
  </Step>
...
For detailed API implementation, refer to the [**Social Plus API Documentation**](../social+-apis-and-services/).
