...
<Steps>
  ...
  <Step title="Monitor and Optimize">
    Review moderation feed regularly to maintain healthy community dynamics
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Content & Safety">
    <CardGroup cols={2}>
  <Card title="AI Content Moderation" icon="shield-check" href="/analytics-and-moderation/console/ai-content-moderation">
        Advanced AI-powered content filtering with customizable rules and automatic enforcement
      </Card>
  <Card title="Manual Review System" icon="eye" href="/analytics-and-moderation/console/moderation/overview">
        Comprehensive manual review workflows for complex moderation decisions
      </Card>
  <Card title="Community Safety" icon="shield-heart" href="/analytics-and-moderation/console/moderation/roles-and-privileges">
  ...
  <Tab title="User Management">
    <CardGroup cols={2}>
  <Card title="User Administration" icon="users" href="/analytics-and-moderation/console/user-and-content-management/mod-feed">
        Comprehensive user account management, roles, and permissions system
      </Card>
  <Card title="User History Tracking" icon="rectangle-history" href="/analytics-and-moderation/console/user-and-content-management/user-social-history">
        Detailed user activity tracking and behavioral analysis tools
      </Card>
  <Card title="Access Control" icon="key" href="/analytics-and-moderation/console/management/admin-access-control">
        Advanced admin access control and permission management
      </Card>
      <Card title="Behavior Analytics" icon="chart-user">
        User behavior patterns, engagement metrics, and community information
      </Card>
    </CardGroup>
  </Tab>
  <Tab title="Community Features">
    <CardGroup cols={2}>
  <Card title="Community Management" icon="comments" href="/analytics-and-moderation/console/social-management/README">
        Posts, comments, communities, and social interaction management
      </Card>
  <Card title="Chat Management" icon="messages" href="/analytics-and-moderation/console/chat-management/channel-management">
        Chat channel moderation, message filtering, and conversation management
      </Card>
  <Card title="Premium Advertising" icon="bullhorn" href="/analytics-and-moderation/console/premium-ads/setting-up-premium-ads">
        Monetization tools, ad campaign management, and revenue optimization
      </Card>
  <Card title="Analytics Dashboard" icon="chart-bar" href="/analytics-and-moderation/console/analytics/overview">
        Comprehensive analytics, engagement metrics, and performance insights
      </Card>
  <Card title="Admin on the go" icon="mobile-screen" href="/analytics-and-moderation/admin-on-the-go/overview">
        Mobile-optimized console for reviewing and moderating content from your phone
      </Card>
    </CardGroup>
  </Tab>
</Tabs>
...
<Card title="Admin on the go" icon="mobile-screen" href="/analytics-and-moderation/admin-on-the-go/overview">
  The mobile-optimized version of the Console at [go.social.plus](https://go.social.plus) — review pending posts, clear flags, edit content, and publish from your phone, using the same account and the same permissions.
</Card>

Admin on the go covers the time-sensitive moderation workflows: approving and declining pending posts, flagging and unflagging posts and comments, editing and deleting content, featuring posts globally, and creating or scheduling posts. Configuration, analytics, and advanced administration stay in the full Console.

## Getting Started Resources

<CardGroup cols={3}>
  <Card title="Initial Setup Guide" icon="play" href="/analytics-and-moderation/console/getting-started/overview">
    Complete walkthrough of console configuration, from basic setup to advanced features
  </Card>
  <Card title="Moderation Mastery" icon="shield" href="/analytics-and-moderation/console/moderation/overview">
    Comprehensive guide to content moderation, community safety, and automated enforcement
  </Card>
  <Card title="Analytics Deep Dive" icon="chart-line" href="/analytics-and-moderation/console/analytics/overview">
