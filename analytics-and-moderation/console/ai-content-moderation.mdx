...
<AccordionGroup>
  <Accordion title="Detection Categories" icon="text">
    ...
    The following categories are available on request. Contact our [support team](mailto:support@social.plus) to have them enabled for your network.

    - **`Harassment`**: Targeted abuse, intimidation, or bullying behavior
    - **`Illicit`**: Illegal goods and services
    - **`Scam`**: Scam tactics, phishing, fake giveaways, and deceptive content
    - **`Profanity`**: Untargeted swearing
...
<AccordionGroup>
  <Accordion title="Confidence Thresholds" icon="sliders">
    ...
    **Flag Confidence-Text** (Default: 3, or 2 for `SelfHarm`)
    - Content scoring at or above this level gets flagged for review
    - Lower values = more content flagged (higher sensitivity)
    - Recommended range: 2-4 depending on community standards

    **Block Confidence-Text** (Default: 5)
    - Content scoring at or above this level gets automatically removed
    - Higher values = fewer false positives
    - Recommended range: 5-6 for balanced protection
  </Accordion>
  ...
  <Tab title="Configuration APIs">
    <CodeGroup>
      ...
      curl -X PUT 'https://apix.eu.amity.co/api/v3/network-settings/enhance-moderation' \
        ...
        { "category": "SelfHarm", "flagConfidence": 2, "blockConfidence": 5, "moderationType": "text" },
        { "category": "Harassment", "flagConfidence": 3, "blockConfidence": 6, "moderationType": "text" },
        { "category": "Illicit", "flagConfidence": 2, "blockConfidence": 5, "moderationType": "text" },
        { "category": "Scam", "flagConfidence": 3, "blockConfidence": 6, "moderationType": "text" },
        { "category": "Profanity", "flagConfidence": 3, "blockConfidence": 7, "moderationType": "text" },
