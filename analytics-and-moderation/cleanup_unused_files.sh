...
declare -a files_to_remove=(
    "social+-portal/changelogs.md"
    "social+-portal/account-management.md" 
    "social+-portal/getting-started.md"
    "social+-portal/README.md"
    "social+-portal/application-management.md"
    "social+-apis-and-services/pre-hook-event.md"
    "social+-apis-and-services/network-settings.md"
    "social+-apis-and-services/generate-user-last-activity-report.md"
    "social+-apis-and-services/README.md"
