...
description: "Configure platform-wide settings and user experience controls through Social+ Network Settings APIs for comprehensive application management."
---

# Network Settings

Network Settings APIs provide comprehensive control over platform-wide configurations that affect all users in your Social+ application. These settings enable you to customize user experience, privacy controls, and feature availability across your entire network.
