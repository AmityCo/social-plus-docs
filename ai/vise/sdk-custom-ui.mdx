...
<CardGroup cols={2}>
  <Card title="Choose an integration path" icon="route" href="/ai/vise/choose-integration-path">
    Compare custom SDK ownership with a prebuilt UIKit surface.
  </Card>
  <Card title="Launch a standard social experience" icon="window" href="/ai/vise/uikit-quickstart">
