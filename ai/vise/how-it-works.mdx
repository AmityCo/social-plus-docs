...
<CardGroup cols={2}>
  ...
  <Card title="Keep integrations verified in CI" icon="code-branch" href="/ai/vise/ci-verification">
    Carry the same contract and evidence into the pipeline.
  </Card>
  <Card title="Command reference" icon="terminal" href="/ai/vise/cli-reference">
