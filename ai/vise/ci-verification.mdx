...
<Accordion title="Advanced: compare an approved and candidate release" icon="terminal">
  ...
  A `ready` result supports human release review; it does not record approval. See the [command reference](/ai/vise/cli-reference) for exact exit codes and trust-policy options.
</Accordion>
