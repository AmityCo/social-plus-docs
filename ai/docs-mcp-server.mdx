...
sidebarTitle: "Docs in your editor"
...
<Card title="Installation" icon="plug" href="/ai/docs-mcp-installation" horizontal>
  Step-by-step setup for Claude, VS Code, and Cursor.
</Card>
