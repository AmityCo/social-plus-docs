...
<Update label="8.2.0  (05/06/2026)" tags={["New Releases", "Improvements"]}>
  ...
  #### Community Query with Tags
  Added community tags query support, enabling communities to be filtered and discovered by tags.

  #### Visitor Usage Limit
  Implemented visitor usage limit — the SDK now tracks and surfaces limit-reached states for unauthenticated users.
