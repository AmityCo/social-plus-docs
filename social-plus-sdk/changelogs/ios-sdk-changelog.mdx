...
<Update label="7.18.0  (20/03/2026)" tags={["New Releases"]}>
  ## 🚀 New Features
  ...
  Introduce product management APIs for livestreams — tag, pin, and remove products across all broadcast phases. Includes real-time product sync, co-host product permission controls, and product analytics via `markAsViewed` and `markAsClicked`.

  #### Specific Xcode support

  26.2 =\> 7.18.0

  16.x =\> 7.18.0-xcode16.4

  26.1 =\> 7.18.0-xcode26.1\
  \
  26.3 =\> 7.18.0-xcode26.3
