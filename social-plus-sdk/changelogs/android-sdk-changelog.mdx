...
<Update label="7.26.0  (11/09/2026)" tags={["New Releases"]}>
  ## 🚀 New Features

  #### Configurable User Search Fields

  Added an opt-in `searchBy` option to user search so callers can restrict which user fields the keyword is matched against.
