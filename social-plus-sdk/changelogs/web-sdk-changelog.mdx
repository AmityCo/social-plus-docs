...
<Update label="7.22.0  (05/06/2026)" tags={["New Releases"]}>
  ...
  #### Visitor Usage Limit
  Added visitor usage limit support — the SDK now surfaces limit-reached states for unauthenticated users, enabling apps to prompt sign-in or restrict access when the visitor quota is exhausted.
