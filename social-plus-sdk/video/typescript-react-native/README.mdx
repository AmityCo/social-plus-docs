...
For details on using the TypeScript SDK with **React Native**, see the [Installation & Quick Start guide](/social-plus-sdk/getting-started/overview#react-native) which includes platform requirements and initialization.
