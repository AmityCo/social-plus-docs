...
3. **[Flutter-Specific Setup](../../video-new/platform-specific/flutter-specific.mdx)** - Flutter platform details
...
![](<../../../.gitbook/assets/image (57).png>)iption: Ensure that your users don’t miss important content from each other.
---
