...
<Tabs>
  <Tab title="Basic Receipt Sync">
    ...
    **Getting the subChannelId**: Pass `channel.defaultSubChannelId` (iOS/TypeScript) or `channel.getDefaultSubChannelId()` (Android) — retrieved from the channel object you already have. You do not need to query or manage SubChannel objects separately.
    ...
    class ChatViewController: UIViewController {
        // Obtain from your channel object: channel.defaultSubChannelId
    ...
    class ChatActivity : AppCompatActivity() {
        private val subChannelRepository = AmityChatClient.newSubChannelRepository()
        // Obtain from your channel object: channel.getDefaultSubChannelId()
  ...
  class ChatComponent {
    ...
    // Obtain subChannelId from your channel object: channel.defaultSubChannelId
      ...
      useEffect(() => {
        ...
        const startSync = async () => {
          try {
            ...
            if (isActive) setIsSyncActive(true);
          } catch (error) {
