...
<CardGroup cols={2}>
  <Card title="Text Messages" icon="comment" href="/social-plus-sdk/chat/messaging-features/message-creation/text-message">
    Send formatted text messages with rich content support
  </Card>
  <Card title="Image Messages" icon="image" href="/social-plus-sdk/chat/messaging-features/message-creation/image-message">
    Share images with thumbnails and full-size viewing
  </Card>
  <Card title="Video Messages" icon="video" href="/social-plus-sdk/chat/messaging-features/message-creation/video-message">
    Send video content with preview and playback controls
  </Card>
  <Card title="Audio Messages" icon="microphone" href="/social-plus-sdk/chat/messaging-features/message-creation/audio-message">
    Voice messages and audio file sharing
  </Card>
  <Card title="File Messages" icon="file" href="/social-plus-sdk/chat/messaging-features/message-creation/file-message">
    Share documents and files of various formats
  </Card>
  <Card title="Custom Messages" icon="code" href="/social-plus-sdk/chat/messaging-features/message-creation/custom-message">
    Create custom message types for specialized content
  </Card>
  <Card title="Reply Messages" icon="reply" href="/social-plus-sdk/chat/messaging-features/message-creation/reply-to-a-message">
