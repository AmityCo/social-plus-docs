import SubChannelSendText from '/snippets/social-plus-sdk/chat/sub-channel-send-text.mdx';
import SendAMessage from '/snippets/social-plus-sdk/chat/send-a-message.mdx';
