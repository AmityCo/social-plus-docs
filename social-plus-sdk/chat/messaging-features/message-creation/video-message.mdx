import MessageSendVideo from '/snippets/social-plus-sdk/chat/message_send_video.mdx';
import SubChannelSendVideo from '/snippets/social-plus-sdk/chat/sub_channel_send_video.mdx';
import SendVideoMessage from '/snippets/social-plus-sdk/chat/send_video_message.mdx';
import VideoMessage from '/snippets/social-plus-sdk/chat/video-message.mdx';
import CreateVideoMessage from '/snippets/social-plus-sdk/chat/create-video-message.mdx';
import GetVideoResolutions from '/snippets/social-plus-sdk/chat/get-video-resolutions.mdx';
