import MessageSendVideo from '/snippets/social-plus-sdk/chat/message-send-video.mdx';
import SendVideoMessage from '/snippets/social-plus-sdk/chat/send-video-message.mdx';
import SubChannelSendVideo from '/snippets/social-plus-sdk/chat/sub-channel-send-video.mdx';
