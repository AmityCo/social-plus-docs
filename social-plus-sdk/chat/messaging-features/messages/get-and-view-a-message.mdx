import GetVideoMessageAttribute from '/snippets/social-plus-sdk/chat/get-video-message-attribute.mdx';
import MessageParent from '/snippets/social-plus-sdk/chat/message-parent.mdx';
...
<MessageCreateImageMessage />

    ### Video Message Handling

    <View_custom_message />

<GetVideoMessageAttribute />

<View_video_message_thumbnail />

<Get_video_message_attribute />

    ### File Message Handling

    <MessageCreateVideoMessage />

<View_file_and_audio_message />
