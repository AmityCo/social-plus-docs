...
<Tabs>
  ...
  <Tab title="Android Kotlin">
    {/* doc-as-test: skip(class-body: MessageFlagManager with internal constructor) */}
    ```kotlin
    ...
    class MessageFlagManager {
        async flagMessage(request: FlagRequest): Promise<FlagResult> {
            try {
                ...
                if (reason === ContentFlagReason.OTHERS && customReason) {
                ...
                const result = await flagRepo.flag({
                    reason,
                    customReason: reason === ContentFlagReason.OTHERS ? customReason : undefined
                });
        ...
        private handleFlagSuccess(messageId: string, reason: Amity.ContentFlagReason): void {
        ...
        async flagForHarassment(messageId: string): Promise<FlagResult> {
            return this.flagMessage({
                messageId,
                reason: ContentFlagReason.HARASSMENT_OR_BULLYING
            });
        }
        ...
        async flagForSpam(messageId: string): Promise<FlagResult> {
            return this.flagMessage({
                messageId,
                reason: ContentFlagReason.SPAM_OR_SCAMS
            });
        }
        ...
        async flagWithCustomReason(messageId: string, customReason: string): Promise<FlagResult> {
            return this.flagMessage({
                messageId,
                reason: ContentFlagReason.OTHERS,
                customReason
            });
        }
  ...
  <Tab title="Flutter Dart">
    {/* doc-as-test: skip(class-body-fragment: top-level enum+class, not valid inside function wrapper) */}
    ```dart
...
<Tabs>
  <Tab title="iOS Swift">
    {/* doc-as-test: skip (truly-illustrative: extension declaration inside a function body is invalid Swift — illustrative class scaffold only) */}
    ```swift
  ...
  <Tab title="Android Kotlin">
    {/* doc-as-test: skip(class-method-body: uses messageRepository member variable) */}
    ```kotlin
  ...
  <Tab title="Flutter Dart">
    {/* doc-as-test: skip(class-body-fragment: methods reference sibling class methods, not valid as standalone snippet) */}
    ```dart
...
<Tabs>
  ...
  <Tab title="Flutter Dart">
    {/* doc-as-test: skip(class-body-fragment: static fields + class definition, not valid inside function wrapper) */}
    ```dart
    Future<bool> checkIfMessageIsFlagged(String messageId) async {
        try {
            final isFlagged = await AmityChatClient.newMessageRepository()
...
<CardGroup cols={2}>
  <Card
    ...
    icon="shield"
    href="/social-plus-sdk/chat/moderation-safety/content-moderation/overview"
  >
    ...
    <Card
        ...
        icon="users"
        href="/social-plus-sdk/chat/moderation-safety/member-management/roles-and-permission"
    >
  ...
  <Card
    ...
    icon="bolt"
    href="/social-plus-sdk/core-concepts/realtime-communication/realtime-events/overview"
  >
