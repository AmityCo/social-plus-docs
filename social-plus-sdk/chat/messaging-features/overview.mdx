...
<CardGroup cols={2}>
  ...
  <Card title="Pin Messages" href="./messages/pin-message" icon="thumbtack">
    Pin one message above a livestream chat and keep it in sync through the channel live object.
  </Card>
</CardGroup>
