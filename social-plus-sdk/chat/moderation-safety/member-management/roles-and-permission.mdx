...
social.plus uses roles and permissions to provide users the ability to fully customize the moderation experience on the platform. To learn more about social.plus SDKs default roles and permissions, refer to the [Roles & Permissions](/social-plus-sdk/core-concepts/user-management/roles-permissions) page.
