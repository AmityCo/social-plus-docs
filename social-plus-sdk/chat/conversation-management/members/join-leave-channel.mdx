...
import CheckChannelMembership from '/snippets/social-plus-sdk/chat/check-channel-membership.mdx';
import ChannelMembership from '/snippets/social-plus-sdk/chat/channel-membership.mdx';
import ChannelParticipationInit from '/snippets/social-plus-sdk/chat/channel-participation-init.mdx';
...
<ChannelMemberRemove />
    ...
    <ChannelMembersAddRemove />

    <ChannelParticipationInit />

    <ChannelMembershipInitialization />
