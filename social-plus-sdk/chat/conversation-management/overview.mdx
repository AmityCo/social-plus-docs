...
<CardGroup cols={3}>
  <Card title="Create Your First Channel" href="/social-plus-sdk/chat/conversation-management/channels/create-channel" icon="plus">
    Step-by-step channel creation guide
  </Card>
  <Card title="Implement Member Management" href="/social-plus-sdk/chat/conversation-management/members/overview" icon="users">
    Build member joining and governance
  </Card>
  <Card title="Set Up Moderation" href="/social-plus-sdk/chat/conversation-management/overview" icon="shield-check">
