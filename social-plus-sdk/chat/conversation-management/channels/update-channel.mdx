...
import ChannelUpdateMetadata from '/snippets/social-plus-sdk/chat/channel-update-metadata.mdx';
...
import ChannelUpdate from '/snippets/social-plus-sdk/chat/channel-update.mdx';
