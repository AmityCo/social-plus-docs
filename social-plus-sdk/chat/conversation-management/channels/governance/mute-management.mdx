import ChannelMemberMute from '/snippets/social-plus-sdk/chat/channel-member-mute.mdx';
import LiveChannelMemberMute from '/snippets/social-plus-sdk/chat/live-channel-member-mute.mdx';
import MuteChannelMember from '/snippets/social-plus-sdk/chat/mute-channel-member.mdx';
import LiveChannelMemberUnmute from '/snippets/social-plus-sdk/chat/live-channel-member-unmute.mdx';
...
<ChannelUnmute />
    ...
    <LiveChannelMemberMute />

    <MuteChannelMember />

    <ChannelMuteUser />

    <ChannelModerationMuteMembers />
