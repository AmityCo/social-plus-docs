...
Use channel roles when selected members need elevated channel permissions, such as moderator behavior. Role names are app-defined or configured for your social.plus project; the SDK applies or removes the role for the listed channel members.
