...
<CardGroup cols={2}>
  ...
  <Card title="Member Management" href="/social-plus-sdk/chat/conversation-management/channels/governance/member-management" icon="user-plus">
...
<CardGroup cols={3}>
  ...
  <Card title="Member Management" href="/social-plus-sdk/chat/conversation-management/members/query-members" icon="users">
    **Member Operations**
    Query and manage channel membership
  </Card>
  <Card title="Content Moderation" href="/social-plus-sdk/chat/conversation-management/overview" icon="shield-check">
    **Content Safety**
