  ...
  <Tab title="Basic Search">
    **Core search functionality**
    ...
    func queryChannelExample() {
        ...
        let query = AmityChannelQueryOptions(
            types: [AmityChannelQueryType.conversation],
            filter: .all,
            includingTags: ["dog"],
            excludingTags: ["cat"],
        ...
        token = channelRepository.getChannels(with: query).observe { liveCollection, error in
            // ...
        }
