import ChannelCreate from '/snippets/social-plus-sdk/chat/channel_create.mdx';
import ChannelCreationCommunity from '/snippets/social-plus-sdk/chat/channel-creation-community.mdx';
...
import CreateChannelRepository from '/snippets/social-plus-sdk/chat/create_channel_repository.mdx';
import ChannelCreationConversation from '/snippets/social-plus-sdk/chat/channel-creation-conversation.mdx';
import ChannelRepoInitialization from '/snippets/social-plus-sdk/chat/channel-repo-initialization.mdx';
import ChannelCreationLive from '/snippets/social-plus-sdk/chat/channel-creation-live.mdx';
import ChannelCreateConversation from '/snippets/social-plus-sdk/chat/channel-create-conversation.mdx';
import CreateChannelRepositoryUsage from '/snippets/social-plus-sdk/chat/create_channel_repository_usage.mdx';
...
<ChannelCreate />
    ...
    <ChannelCreationCommunity />

    <ChannelCreateCommunity />
  ...
  <Tab title="Conversation Channels">
    ...
    **Auto-Generated IDs**: Channel IDs for conversation channels are always generated by the SDK to ensure uniqueness and prevent conflicts.
    ...
    <ChannelCreationConversation />

    <ChannelCreateConversation />
...
<ChannelRepoInitialization />

<CreateChannelRepositoryUsage />
