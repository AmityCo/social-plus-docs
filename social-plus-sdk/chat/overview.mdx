...
<Steps>
  ...
  <Step title="Add Messaging">
    Implement [message sending](messaging-features/message-creation/send-a-message) and handling.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="../getting-started/overview">
    Get up and running with our step-by-step guides
  </Card>
  <Card title="API Reference" icon="code" href="/api-reference/introduction">
    Explore our comprehensive API documentation
  </Card>
  <Card title="Code Examples" icon="file-code" href="../getting-started/examples">
