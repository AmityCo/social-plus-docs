...
description: "Comprehensive Android-specific implementation details for Social+ Video SDK integration"
---

# Android Implementation Guide

Complete guide for implementing Social+ Video SDK in Android applications using Kotlin and modern Android development practices.
...
class VideoFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        // Register with Social+ Video SDK
