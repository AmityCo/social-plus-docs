...
const stream = await StreamRepository.getStreamById('stream-123');
...
```typescript TypeScript
// Legacy Stream Post — this method was renamed; see createRoomPost below
// await PostRepository.createRoomPost({ ... }); // ← use this name going forward
