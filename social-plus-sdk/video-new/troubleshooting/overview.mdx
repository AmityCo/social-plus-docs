...
description: "Comprehensive troubleshooting guide for Social+ Video SDK"
---

# Troubleshooting Overview

This guide provides solutions to common issues encountered when using the Social+ Video SDK. Whether you're experiencing streaming problems, playback issues, or integration challenges, you'll find help here.

## Quick Diagnostic Steps

### 1. Check SDK Version
Ensure you're using the latest version of the Social+ Video SDK:
...
const sdk = new SocialPlusVideo({
  apiKey: 'your-api-key',
  useCDN: true, // Use Social+ CDN to avoid CORS
