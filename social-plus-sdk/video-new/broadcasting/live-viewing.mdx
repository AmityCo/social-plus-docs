...
Resolution carries the stream's aspect ratio, width, and height. Both fields can be absent early in a session, so treat them as optional and fall back to your own placeholder. See [Rooms Overview](./rooms-overview) for the full room field reference.
