...
description: "Comprehensive guide to camera management and controls in Social+ Video SDK"
---

# Camera Controls

The Social+ Video SDK provides extensive camera control capabilities for creating professional broadcasting experiences. This guide covers all available camera features and how to implement them across different platforms.
