...
description: "Handle camera, microphone, and storage permissions across platforms for Social+ Video SDK implementation"
---
...
Social+ Video SDK requires the following permissions for full functionality:
