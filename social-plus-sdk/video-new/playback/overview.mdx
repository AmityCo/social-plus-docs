...
description: "Comprehensive guide to video playback and viewer experience with Social+ SDK"
---

# Playback Overview

The Social+ Video SDK provides robust video playback capabilities that deliver exceptional viewing experiences across all platforms. This guide covers everything from basic playback to advanced viewer features.

## What is Video Playback?

Video playback in the Social+ SDK encompasses all aspects of the viewer experience, from stream discovery to interactive viewing features. Our playback system is optimized for low latency, high quality, and seamless user experience.
