...
- **Interactive Co-Hosting**: Invite guests to join your broadcast with real-time audio/video streaming
...
- **Real-time Co-Host Events**: Monitor co-host invitations, joins, leaves, and removals in real-time
...
### Rooms & Broadcasting
Learn how to enable users to create and broadcast live streams with interactive co-hosting:
- **[Rooms Overview](./broadcasting/rooms-overview.mdx)** - Understanding room types, lifecycle, and participants
- **[Create & Manage Rooms](./broadcasting/create-room.mdx)** - Create and configure streaming rooms
...
### Co-Hosting
Enable interactive multi-host streaming experiences:
- **[Co-Host Management](./broadcasting/rooms-overview.mdx#co-host-management)** - Invite, accept, and manage co-hosts
- **[Co-Host Events](./broadcasting/rooms-overview.mdx#co-host-events)** - Real-time event monitoring for co-host activity
- **[LiveKit Integration](./broadcasting/rooms-overview.mdx#connecting-to-livekit)** - Connect co-hosts to streaming infrastructure
...
Comprehensive guides for implementing social.plus Video SDK on each supported platform:
