...
<CardGroup cols={2}>
  ...
  <Card title="Real-time Events" href="/social-plus-sdk/core-concepts/realtime-communication/realtime-events/overview">
    Build reactive applications with real-time event handling
  </Card>
  
  <Card title="Live Objects" href="/social-plus-sdk/core-concepts/realtime-communication/live-objects-collections/overview">
