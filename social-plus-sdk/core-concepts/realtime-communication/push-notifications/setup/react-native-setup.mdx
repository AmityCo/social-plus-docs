...
<CardGroup cols={2}>
  ...
  <Card title="iOS Certificate Setup" href="./ios-push-notification-certificate-setup" icon="apple">
    Detailed iOS APNs certificate generation guide
  </Card>
  <Card title="Android FCM Setup" href="./setup/android-setup" icon="android">
