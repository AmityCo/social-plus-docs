...
<CardGroup cols={2}>
  <Card title="Posts" icon="pen-to-square" href="/social-plus-sdk/core-concepts/content-handling/mentions">
    Learn about mentions in posts
  </Card>
  
  <Card title="Comments" icon="comment" href="/social-plus-sdk/core-concepts/content-handling/mentions">
