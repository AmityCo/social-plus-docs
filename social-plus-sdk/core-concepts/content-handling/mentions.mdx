...
Mentions are attached to content creation or edit calls. They use two pieces of data: `mentionees` tells social.plus which users or channel are mentioned, and `metadata` stores the text ranges your UI can use to render the highlighted mention text.
