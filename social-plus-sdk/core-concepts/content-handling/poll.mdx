...
<CardGroup cols={2}>
  <Card title="Social Posts" icon="pen-to-square" href="/social-plus-sdk/social/content-management/posts/creation/poll-post">
    Learn how to create posts with embedded polls
  </Card>
  <Card title="Discovery & Engagement" icon="compass" href="/social-plus-sdk/social/discovery-engagement/overview">
    Explore discovery, feed, search, and notification features
  </Card>
  <Card title="Real-time Updates" icon="bolt" href="/social-plus-sdk/core-concepts/realtime-communication/realtime-events/social-realtime-events">
