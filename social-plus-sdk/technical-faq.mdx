...
<AccordionGroup>
  ...
  <Accordion title="How should we properly set up push notifications in iOS?">
    ...
    2. Configure your backend / social.plus console
  ...
  <Accordion title="How do we access or initialize social.plus correctly in our environment?">
...
<AccordionGroup>
  ...
  <Accordion title="How do we manage or delete stuck/inactive applications via Portal?">
    The social.plus Portal does not support deleting applications once created, an app remains in your list permanently. You can only rename existing apps to keep things organized, and if you're nearing the 50-app cap, contact support to request a limit increase.
  </Accordion>
</AccordionGroup>
