...
For comprehensive mention rendering support including custom styling, hover cards, and interactive elements, refer to our [Core Concepts - Mentions](/social-plus-sdk/core-concepts/mentions) documentation which covers:
...
- [Core Concepts - Mentions](/social-plus-sdk/core-concepts/mentions) - Complete mention system guide
- [Create Comment](./create-comment.mdx) - Basic comment creation
- [Push Notifications](/social-plus-sdk/core-concepts/push-notifications) - Notification setup and handling
