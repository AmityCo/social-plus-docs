...
For comprehensive mention rendering support including custom styling, hover cards, and interactive elements, refer to our [Core Concepts - Mentions](../../core-concepts/mentions/) documentation which covers:
...
- [Core Concepts - Mentions](../../core-concepts/mentions/) - Complete mention system guide
- [Create Comment](./create-comment.mdx) - Basic comment creation
- [Push Notifications](../../core-concepts/push-notifications/) - Notification setup and handling
- [User Management](../user/) - User search and profile features
- [Real-time Events](../../core-concepts/realtime-events/) - Live mention updates