...
class CommentQueryManager {
    ...
    async createPaginatedQuery(
        options: CommentQueryOptions
    ): Promise<Amity.LiveCollection<AmityComment>> {
        const query: AmityCommentQuery = {
    ...
    async loadMoreComments(liveCollection: Amity.LiveCollection<AmityComment>): Promise<void> {
...
function useComments(
    ...
    const liveCollectionRef = React.useRef<Amity.LiveCollection<AmityComment> | null>(null);
