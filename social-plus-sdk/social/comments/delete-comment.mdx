...
class CommentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        deletionManager = CommentDeletionManager(AmityCommentRepository.getComment())
...
class CommentDeletionService {
  ...
  CommentDeletionService(this._commentRepository);
...
class _CommentListWidgetState extends State<CommentListWidget> {
  ...
  void initState() {
    super.initState();
    _deletionService = CommentDeletionService(AmitySocialClient.newCommentRepository());
  }
    ...
    return when (throwable) {
        is AmityException -> {
            when (throwable.code) {
                ...
                AmityError.ITEM_NOT_FOUND -> CommentDeletionResult.Error.CommentNotFound
