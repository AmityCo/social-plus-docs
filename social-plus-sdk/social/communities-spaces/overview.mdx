...
| `needApprovalOnCommentCreation` (TypeScript) / `isCommentReviewEnabled` (iOS) | Boolean | Whether members' comments are held for moderator review. Not exposed on Android or Flutter. See [Comment Review](/social-plus-sdk/social/content-management/comments/moderation/comment-review) |
