...
Use the community APIs to create communities, manage membership and roles, control content moderation, and organize discovery. Communities support public and private access modes, join approval workflows, role-based permissions, and post or story moderation settings.
