import GetTrendingCommunities from '/snippets/social-plus-sdk/social/get_trending_communities.mdx';
import GetRecommendedCommunities from '/snippets/social-plus-sdk/social/get-recommended-communities.mdx';
