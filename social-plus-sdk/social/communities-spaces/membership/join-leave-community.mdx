---
title: "Community Membership Management"
...
<CardGroup cols={2}>
  <Card title="Query Community Members" href="query-community-members" icon="users">
    View and manage community member lists
  </Card>
  <Card title="Community Discovery" href="../discovery/query-communities" icon="magnifying-glass">
    Find communities to join through search and recommendations
  </Card>
  ...
  <Card title="Get Community Details" href="../discovery/get-community" icon="circle-info">
    Retrieve community information before joining
  </Card>
</CardGroup>
