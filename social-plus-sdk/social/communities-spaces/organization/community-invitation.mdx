import UserAcceptInvitation from '/snippets/social-plus-sdk/social/user-accept-invitation.mdx';
import UserDeclineInvitation from '/snippets/social-plus-sdk/social/user_decline_invitation.mdx';
import InvitationGetMyCommunity from '/snippets/social-plus-sdk/social/invitation_get_my_community.mdx';
import GetPendingInvitations from '/snippets/social-plus-sdk/social/get_pending_invitations.mdx';
import CommunityInvitationDecline from '/snippets/social-plus-sdk/social/community-invitation-decline.mdx';
import CommunityInvitationAccept from '/snippets/social-plus-sdk/social/community-invitation-accept.mdx';
import CommunityInvitationList from '/snippets/social-plus-sdk/social/community-invitation-list.mdx';
import CommunityInvitationCreate from '/snippets/social-plus-sdk/social/community-invitation-create.mdx';
import RevokeInvitations from '/snippets/social-plus-sdk/social/revoke-invitations.mdx';
import CommunityInvitationGet from '/snippets/social-plus-sdk/social/community-invitation-get.mdx';
import RevokeInvitation from '/snippets/social-plus-sdk/social/revoke-invitation.mdx';
import SendInvitation from '/snippets/social-plus-sdk/social/send-invitation.mdx';
import InvitationDelete from '/snippets/social-plus-sdk/social/invitation-delete.mdx';
import InvitationCreate from '/snippets/social-plus-sdk/social/invitation-create.mdx';
import InvitationResend from '/snippets/social-plus-sdk/social/invitation-resend.mdx';
import RejectInvitation from '/snippets/social-plus-sdk/social/reject-invitation.mdx';
import CommunitySendInvitation from '/snippets/social-plus-sdk/social/community-send-invitation.mdx';
...
<InvitationGetMyCommunity />


<GetPendingInvitations />


<CommunityInvitationGet />
...
<CommunityGetLiveMemberInvitations />
