import DeleteCommunity from '/snippets/social-plus-sdk/social/delete_community.mdx';
import CommunityDelete from '/snippets/social-plus-sdk/social/community_delete.mdx';
import CommunityLeave from '/snippets/social-plus-sdk/social/community_leave.mdx';
import LeaveCommunity from '/snippets/social-plus-sdk/social/leave_community.mdx';
import DeleteACommunity from '/snippets/social-plus-sdk/social/delete-a-community.mdx';
import CommunityDeletion from '/snippets/social-plus-sdk/social/community-deletion.mdx';
