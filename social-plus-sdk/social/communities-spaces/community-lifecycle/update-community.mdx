...
description: "Update a community's display name, description, privacy, avatar, categories, post moderation, and metadata using updateCommunity()."
---

Call `updateCommunity()` to change a community's display name, description, avatar, category IDs, privacy mode, post moderation setting, story settings, or custom metadata. Only community creators, moderators, and administrators can update community settings. Changes take effect immediately.
