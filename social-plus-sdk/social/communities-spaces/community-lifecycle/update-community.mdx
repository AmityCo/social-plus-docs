...
| `needApprovalOnCommentCreation` / `setNeedApprovalOnCommentCreation(_:)` | TypeScript / iOS | Turn comment review on or off. Turning it off does not clear comments already waiting for review. See [Comment Review](/social-plus-sdk/social/content-management/comments/moderation/comment-review) |
