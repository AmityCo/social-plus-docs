...
| `needApprovalOnCommentCreation` / `setNeedApprovalOnCommentCreation(_:)` | TypeScript / iOS | Hold members' comments for moderator review. Defaults to `false`. See [Comment Review](/social-plus-sdk/social/content-management/comments/moderation/comment-review) |
...
| Concept | TypeScript | iOS | Android | Flutter |
|---------|------------|-----|---------|---------|
| Set on create or update | `needApprovalOnCommentCreation: true` | `setNeedApprovalOnCommentCreation(true)` | Not exposed | Not exposed |
| Read on the community | `community.needApprovalOnCommentCreation` | `community.isCommentReviewEnabled` | Not exposed | Not exposed |

On Android and Flutter, turn comment review on from the Console, a Web or iOS client, or the server API. For who is held, the review queue, and approve or decline, see [Comment Review](/social-plus-sdk/social/content-management/comments/moderation/comment-review).
