import JoinCommunity from '/snippets/social-plus-sdk/social/join_community.mdx';
import CommunityCreate from '/snippets/social-plus-sdk/social/community_create.mdx';
import CreateCommunity from '/snippets/social-plus-sdk/social/create_community.mdx';
import CommunityPostSetting from '/snippets/social-plus-sdk/social/community-post-setting.mdx';
import CommunityPrivateJoin from '/snippets/social-plus-sdk/social/community-private-join.mdx';
import CommunityJoin from '/snippets/social-plus-sdk/social/community_join.mdx';
import CommunityPublicJoin from '/snippets/social-plus-sdk/social/community-public-join.mdx';
import CommunityCreationWithCategory from '/snippets/social-plus-sdk/social/community-creation-with-category.mdx';
...
import LeaveCommunity from '/snippets/social-plus-sdk/social/leave-community.mdx';
import DeleteCommunity from '/snippets/social-plus-sdk/social/delete-community.mdx';
