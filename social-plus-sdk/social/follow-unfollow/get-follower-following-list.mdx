...
<Tabs>
  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      class MyFollowersManager {
          ...
          async getMyFollowersWithStatus(status: Amity.FollowStatus): Promise<void> {
              try {
      ...
      export const useFollowersList = (userId?: string, status: Amity.FollowStatus = 'accepted') => {
          const [followers, setFollowers] = useState<Amity.User[]>([]);
      ...
      function FollowersListComponent({ userId }: { userId?: string }) {
          const [selectedStatus, setSelectedStatus] = useState<Amity.FollowStatus>('accepted');
  ...
  <Tab title="Flutter">
    <CodeGroup>
      ...
      class MyFollowersManager {
        final UserRepository _userRepository = AmityCoreClient.newUserRepository();
...
<Tabs>
  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      async getMyFollowingWithStatus(status: Amity.FollowStatus): Promise<void> {
          try {
      ...
      ```typescript
      export const useFollowingList = (userId?: string, status: Amity.FollowStatus = 'accepted') => {
          const [following, setFollowing] = useState<Amity.User[]>([]);
          const [isLoading, setIsLoading] = useState(true);
          const [error, setError] = useState<string | null>(null);
