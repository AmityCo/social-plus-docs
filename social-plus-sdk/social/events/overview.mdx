...
description: "Create, query, and manage scheduled events with RSVP tracking using EventRepository. Events can be virtual or in-person, community or user-scoped."
---

# Events

Use `EventRepository` to create, update, delete, and query scheduled events. Events support virtual and in-person types, timezone-aware scheduling, cover images, RSVP responses (Going/Not Going), and optional livestream integration. Events can be scoped to a community or a user's timeline.

<Tip>
**Looking for a step-by-step walkthrough?** The [Events & Activities](/use-cases/social/events-and-activities) guide walks you through building event creation, RSVP, and discovery end-to-end.
</Tip>
