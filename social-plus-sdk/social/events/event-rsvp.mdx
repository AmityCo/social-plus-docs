import EventRsvpUpdate from '/snippets/social-plus-sdk/social/event-rsvp-update.mdx';
import EventRsvpGet from '/snippets/social-plus-sdk/social/event-rsvp-get.mdx';
