import EventRsvpCreate from '/snippets/social-plus-sdk/social/event-rsvp-create.mdx';
import EventRsvpMe from '/snippets/social-plus-sdk/social/event-rsvp-me.mdx';
---
title: "Event RSVP"
