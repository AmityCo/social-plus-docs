...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    // Get community by ID
    async function getCommunity(communityId: string): Promise<Amity.Community | null> {
      try {
        const community = await CommunityRepository.getCommunity(communityId);
        
        // Access community properties
        console.log('Amity.Community Name:', community.displayName);
        ...
        console.log('Amity.Post Settings:', community.postSettings);
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ```typescript
    function displayCommunityDetails(community: Amity.Community) {
      // Basic information
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    function handleGetCommunityError(error: any) {
      ...
      switch (error.code) {
        case 'NOT_FOUND':
          message = 'Amity.Community not found';
          break;
        case 'PERMISSION_DENIED':
          message = 'Access denied to this community';
          break;
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    class CommunityComponent {
      ...
      observeCommunityUpdates() {
        this.unsubscribe = CommunityRepository.getCommunity(
          this.communityId,
          (community) => {
...
async function checkCommunityAccess(communityId: string) {
  ...
  if (!community) {
    return { canAccess: false, reason: 'Amity.Community not found' };
  }
...
function displayCommunityStats(community: Amity.Community) {
  return {
