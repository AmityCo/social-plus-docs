...
<CodeGroup>
```swift iOS
let liveRoomPosts = AmityPostRepository().getLiveRoomPosts()
...
```dart Flutter
final liveRoomPosts = AmitySocialClient.newPostRepository().getLiveRoomPosts();
...
<CodeGroup>
```swift iOS
let communityLiveRooms = AmityPostRepository().getCommunityLiveRoomPosts(
...
```dart Flutter
final communityLiveRooms = AmitySocialClient.newPostRepository().getCommunityLiveRoomPosts(
    communityIds: ["community-123", "community-456"]
);
...
<CodeGroup>
```swift iOS
let singleCommunityLiveRooms = AmityPostRepository().getCommunityLiveRoomPosts(
...
```dart Flutter
final singleCommunityLiveRooms = AmitySocialClient.newPostRepository().getCommunityLiveRoomPosts(
    communityIds: ["community-123"]
);
```
</CodeGroup>
