...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    class PostRetriever {
      ...
      async getPost(postId: string): Promise<Amity.Post> {
        try {
          const post = await PostRepository.getPost(postId);
          
          console.log('Amity.Post retrieved:', {
            id: post.postId,
            author: post.userId,
            content: post.data,
      ...
      // Get post with live updates
      observePost(postId: string): Amity.LiveObject<Amity.Post> {
        const liveObject = PostRepository.getPost(postId);
        
        liveObject.on('dataUpdated', (post: Amity.Post) => {
          console.log('Amity.Post updated:', {
            id: post.postId,
        ...
        liveObject.on('dataError', (error: Error) => {
          console.error('Amity.Post observation error:', error);
        });
      ...
      private handlePostUpdate(post: Amity.Post): void {
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ```typescript
    async getMultiplePosts(postIds: string[]): Promise<Amity.Post[]> {
      try {
        ...
        posts.forEach(post => {
          console.log(`Amity.Post ${post.postId}:`, {
            author: post.userId,
            type: post.dataType,
            reactions: post.reactionsCount,
            comments: post.commentsCount
    ...
    observeMultiplePosts(postIds: string[]): Amity.LiveCollection<Amity.Post> {
      const liveCollection = PostRepository.getPostByIds(postIds);
      
      liveCollection.on('dataUpdated', (posts: Amity.Post[]) => {
