...
<Note>
For comprehensive poll creation and management features, refer to the [Poll Management Guide](/social-plus-sdk/core-concepts/content-handling/poll-handling). Poll posts automatically inherit all poll features including expiration, vote limits, and moderation controls.
</Note>