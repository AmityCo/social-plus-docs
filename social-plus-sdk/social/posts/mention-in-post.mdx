...
<Tabs>
  ...
  <Tab title="TypeScript">
    ```typescript
    import { PostRepository, UserRepository } from '@amityco/ts-sdk';
    ...
    class PostMentionManager {
      ...
      async createTextPostWithMentions(
        ...
        try {
          ...
          console.log('Amity.Post with mentions created successfully');
          return post;
        } catch (error) {
  ...
  <Tab title="TypeScript">
    ...
    async updatePostWithMentions(
      ...
      try {
        ...
        console.log('Amity.Post updated with mentions successfully');
        return true;
      } catch (error) {
...
For comprehensive mention rendering guidelines, including metadata structure, custom mention objects, and UI implementation patterns, refer to the [Mentions Guide](/social-plus-sdk/core-concepts/content-handling/mentions) documentation.
