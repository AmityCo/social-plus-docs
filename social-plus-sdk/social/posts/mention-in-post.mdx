...
For comprehensive mention rendering guidelines, including metadata structure, custom mention objects, and UI implementation patterns, refer to the [Mentions Core Concept](/social-plus-sdk/core-concepts/mentions#render-mentions) documentation.
