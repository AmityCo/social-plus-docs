...
<Tabs>
  ...
  <Tab title="Android">
    <CodeGroup>
      ...
      class AdvancedReactionQueryManager(private val client: Client) {
          private val reactionRepository = AmityReactionRepository(client)
  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      export const useReactionQuery = (
          ...
          const [reactions, setReactions] = useState<Amity.Reaction[]>([]);
      ...
      const generateAnalytics = (reactions: Amity.Reaction[]): ReactionAnalytics => {
