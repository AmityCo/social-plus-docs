...
<Note>
The current public Flutter SDK source does not expose hashtag post search. Semantic post search is available on Flutter.

Flutter semantic post search requires `amity_sdk` 7.8.7 or later.
</Note>
...
| Target | `targetType`, `targetId` | `targetType`, `targetId` | `targetType`, `targetId` | `targetType`, `targetId` |
| Data types | `dataTypes` | `dataTypes` | `postTypes` | `postTypes` |
| Parent-only matching | `matchingOnlyParentPost` | `matchingOnlyParentPost` | `matchingOnlyParentPosts` | `matchingOnlyParentPosts` |
| Mixed structure | `includeMixedStructure` | `includeMixedStructure` | `includeMixedStructure` | `includeMixedStructure` |
...
| Parameter | TypeScript | iOS | Android | Flutter |
| --- | --- | --- | --- | --- |
| Hashtags | `hashtags` | `hashtags` | `hashtags` | Not available |
| Target | `targetType` | Not exposed | Not exposed | Not available |
| Data types | `dataTypes` | `dataTypes` | `dataTypes` | Not available |
| Parent-only matching | `matchingOnlyParentPost` | `matchingOnlyParentPost` | Not exposed in the snippet surface | Not available |
| Mixed structure | `includeMixedStructure` | `includeMixedStructure` | `includeMixedStructure` | Not available |
