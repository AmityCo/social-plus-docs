...
<CardGroup cols={2}>
  <Card title="Intelligent Search Posts" icon="messages" href="./intelligent-search-post">
    Learn how to implement semantic search for posts with filtering and customization options
  </Card>

  <Card title="Intelligent Search Communities" icon="users" href="./intelligent-search-community">
