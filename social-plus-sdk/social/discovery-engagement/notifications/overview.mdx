...
description: "Query and manage in-app notification items for posts, reactions, comments, replies, mentions, and follows using the Notification Tray SDK."
---

The Notification Tray SDK lets users receive in-app notifications for posts, reactions, comments, replies, mentions, and follow actions. It provides per-item and tray-level seen status, cross-device synchronization, and pagination support across iOS, Android, and Web platforms.
