...
description: "Reference for supported notification event types, triggers, recipients, and message templates in the social.plus SDK notification tray."
---

This reference lists the notification event types supported by the social.plus SDK notification tray. Each event type has specific triggers, recipients, and message templates that define how notifications are generated and delivered.
