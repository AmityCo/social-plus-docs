...
description: "Overview of user relationship features: following, blocking, connection status, and follower/following list management."
---

Use `UserRepository` to follow or unfollow users, block or unblock users, check connection status, and retrieve follower or following lists. This guide covers the two core systems (Following and Blocking) and their behavior.

<Tip>
**Looking for a step-by-step walkthrough?** The [User Profiles & Social Graph](/use-cases/social/user-profiles-and-social-graph) guide walks you through building follow/unfollow, blocking, and social graph features end-to-end.
</Tip>
