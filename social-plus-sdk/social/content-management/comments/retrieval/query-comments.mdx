...
| **`pageSize`**       | Integer | Number of comments to load per page. Defaults: `20` (iOS), `15` (Android), `10` (Web). Use `5` for reply threads. |
...
<CardGroup cols={2}>
  <Card title="Get Comment" icon="message" href="/social-plus-sdk/social/content-management/comments/retrieval/get-comment">
  ...
  <Card title="Comment Reactions" icon="heart" href="/social-plus-sdk/social/comments/get-comment-reaction-data">
    Implement reaction features for comment engagement
  </Card>
  <Card title="Live Collections" icon="refresh" href="/social-plus-sdk/core-concepts/realtime-communication/live-objects-collections/overview">
