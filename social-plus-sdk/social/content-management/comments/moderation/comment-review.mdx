...
| Create or update a community | Carries the `needApprovalOnCommentCreation` setting on TypeScript and iOS. | [Update Community](/social-plus-sdk/social/communities-spaces/community-lifecycle/update-community) · [Require Review](#require-review-for-community-comments) |
