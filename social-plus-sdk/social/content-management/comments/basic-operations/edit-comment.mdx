...
<Info>
Before editing images in comments, ensure images are uploaded to obtain file IDs. Refer to the [Image Handling Guide](../../core-concepts/files-images-and-videos/image-handling.md#upload-images) for upload procedures.
</Info>
