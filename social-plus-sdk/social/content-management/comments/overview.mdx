...
<Note>
  A community can require a moderator to approve comments before anyone else sees them. In such a community, a created or edited comment comes back `pending` and stays out of public comment lists and counts until it is approved. See [Comment Review](./moderation/comment-review).
</Note>
