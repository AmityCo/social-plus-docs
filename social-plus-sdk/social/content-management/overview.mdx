---
title: "Overview"
description: "Create, retrieve, moderate, and measure posts, comments, stories, and share links with the social.plus SDKs"
---
...
| Post `localCommentCount` | TypeScript, iOS, and Android expose a locally computed live comment count. Flutter's current public post model does not expose this field. Deprecated with comment approval (iOS/TS) — use `getLocalCommentCount(includePending:)`. |
