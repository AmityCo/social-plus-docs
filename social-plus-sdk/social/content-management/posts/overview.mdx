...
| `localCommentCount`  | Integer               | Total number of comments created or deleted locally or received via real-time events (RTE) in the post. This count is overwritten with the server count when synced. |
