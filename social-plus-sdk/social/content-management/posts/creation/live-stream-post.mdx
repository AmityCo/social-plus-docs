...
<CardGroup cols={3}>
  <Card title="Video SDK" href="/social-plus-sdk/video/README" icon="video">
  ...
  <Card title="Community Engagement" href="/social-plus-sdk/social/communities-spaces/overview" icon="users">
