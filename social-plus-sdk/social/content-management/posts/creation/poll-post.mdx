import CreateTextPollPost from '/snippets/social-plus-sdk/social/create_text_poll_post.mdx';
import VotePoll from '/snippets/social-plus-sdk/social/vote-poll.mdx';
import PollQuery from '/snippets/social-plus-sdk/social/poll-query.mdx';
import PollObserve from '/snippets/social-plus-sdk/social/poll-observe.mdx';
import PollOptionAdd from '/snippets/social-plus-sdk/social/poll-option-add.mdx';
import ClosePoll from '/snippets/social-plus-sdk/social/close-poll.mdx';
import CreatePoll from '/snippets/social-plus-sdk/social/create-poll.mdx';
import GetPollFromPost from '/snippets/social-plus-sdk/social/get-poll-from-post.mdx';
import CreatePollRepository from '/snippets/social-plus-sdk/social/create-poll-repository.mdx';
import CreateImagePollPost from '/snippets/social-plus-sdk/social/create-image-poll-post.mdx';
import CreatePollPost from '/snippets/social-plus-sdk/social/create-poll-post.mdx';
import PollAnswer from '/snippets/social-plus-sdk/social/poll-answer.mdx';
...
import Create_poll from '/snippets/social-plus-sdk/social/create_poll.mdx';
import PostPollUpload from '/snippets/social-plus-sdk/social/post-poll-upload.mdx';
import Create_poll_post from '/snippets/social-plus-sdk/social/create_poll_post.mdx';
import Create_image_poll_post from '/snippets/social-plus-sdk/social/create_image_poll_post.mdx';
import Close_poll from '/snippets/social-plus-sdk/social/close_poll.mdx';
import PostPollVote from '/snippets/social-plus-sdk/social/post-poll-vote.mdx';
import Vote_a_poll from '/snippets/social-plus-sdk/social/vote_a_poll.mdx';
import PostPolDelete from '/snippets/social-plus-sdk/social/post-pol-delete.mdx';
import PostPollGet from '/snippets/social-plus-sdk/social/post-poll-get.mdx';
import Create_poll_repository from '/snippets/social-plus-sdk/social/create_poll_repository.mdx';
import PostPollCreationWithMention from '/snippets/social-plus-sdk/social/post-poll-creation-with-mention.mdx';
import PostPollClose from '/snippets/social-plus-sdk/social/post-poll-close.mdx';
import Get_poll_from_post from '/snippets/social-plus-sdk/social/get_poll_from_post.mdx';
...
<CardGroup cols={3}>
  <Card title="Poll Display" icon="square-poll-vertical" href="/social-plus-sdk/social/posts/viewing-post-content#poll-post">
  ...
  <Card title="Community Management" icon="users" href="/social-plus-sdk/social/communities-spaces/overview">
