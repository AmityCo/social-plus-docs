import CreateCustomPost from '/snippets/social-plus-sdk/social/create-custom-post.mdx';
...
import Create_custom_post from '/snippets/social-plus-sdk/social/create_custom_post.mdx';
import CustomPostCreation from '/snippets/social-plus-sdk/social/custom-post-creation.mdx';
