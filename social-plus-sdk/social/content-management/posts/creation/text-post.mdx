...
<Info>
**Product Tagging in Text Posts**: You can tag products directly in your post text using the `@` trigger to mention products. Product mentions are tracked separately from user mentions and enable commerce integration in social posts.

Example: "Check out this awesome @product-name at our store!"
</Info>

Product tagging supports:
- Up to 20 product tags per post
- Product mentions integrated directly in post text
- Product metadata tracking for analytics and commerce discovery
- Links to product catalogs and purchasing
