import CreateFilePost from '/snippets/social-plus-sdk/social/create-file-post.mdx';
...
import Create_file_repository from '/snippets/social-plus-sdk/social/create_file_repository.mdx';
import Create_file_post from '/snippets/social-plus-sdk/social/create_file_post.mdx';
import PostFileUpload from '/snippets/social-plus-sdk/social/post-file-upload.mdx';
import Update_file_post from '/snippets/social-plus-sdk/social/update_file_post.mdx';
import Upload_file from '/snippets/social-plus-sdk/social/upload_file.mdx';
...
| **Structure Type** | Pure file posts have `structureType = 'file'` | System-determined based on attachments |

<Info>
  Want to combine files with other media types (images, videos, or audio)? Check out [Mixed Media Posts](./mixed-media-post) which support up to 10 mixed attachments of any type.
</Info>
...
| `files`      | Array/IDs | ✅        | File objects (iOS/Android/Flutter) or file IDs (TS/JS) | |
...
<CardGroup cols={3}>
  <Card title="File Upload" icon="upload" href="/social-plus-sdk/core-concepts/content-handling/files-images-and-videos/file">
  ...
  <Card title="Audio Posts" icon="file-audio" href="./audio-post">
