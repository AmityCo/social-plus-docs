import UploadVideo from '/snippets/social-plus-sdk/social/upload_video.mdx';
import PostVideoUpload from '/snippets/social-plus-sdk/social/post_video_upload.mdx';
import VideoPostCreation from '/snippets/social-plus-sdk/social/video_post_creation.mdx';
import PostVideoCreation from '/snippets/social-plus-sdk/social/post_video_creation.mdx';
import PostCreateVideo from '/snippets/social-plus-sdk/social/post_create_video.mdx';
import VideoPostUpload from '/snippets/social-plus-sdk/social/video-post-upload.mdx';
import GetVideoPost from '/snippets/social-plus-sdk/social/get_video_post.mdx';
import PostEditVideo from '/snippets/social-plus-sdk/social/post_edit_video.mdx';
import CreateVideoPost from '/snippets/social-plus-sdk/social/create-video-post.mdx';
import GetVideoAttributes from '/snippets/social-plus-sdk/social/get-video-attributes.mdx';
import GetAllVideoQualities from '/snippets/social-plus-sdk/social/get-all-video-qualities.mdx';
import GetVideoDataFromPost from '/snippets/social-plus-sdk/social/get-video-data-from-post.mdx';
...
import PostGetPostStream from '/snippets/social-plus-sdk/social/post-get-post-stream.mdx';
import PostReview from '/snippets/social-plus-sdk/social/post-review.mdx';
import PostServiceLocator from '/snippets/social-plus-sdk/social/post-service-locator.mdx';
import SocialNewPostRepository from '/snippets/social-plus-sdk/social/social-new-post-repository.mdx';
import PostGetReactions from '/snippets/social-plus-sdk/social/post-get-reactions.mdx';
