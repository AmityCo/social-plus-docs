...
Pinning, unpinning, featuring, and unfeaturing are performed from the **social.plus Console**, not from the client SDK. The client SDKs surface pinned and featured state as read-only.
