...
fun updateImagePost(
  ...
  val productTags = listOf(
    AmityProductTag.Text(productId = "product1", index = 0, length = 8),
    AmityProductTag.Text(productId = "product2", index = 9, length = 8)
  )

  val attachmentProductTags = AmityAttachmentProductTags(
    mapOf(
      "fileId1" to listOf(
        AmityProductTag.Media(productId = "product1", index = 0)
      )
    )
  )
  ...
  val links = listOf(
    AmityLink(url = "https://example.com", title = "Example")
  )
