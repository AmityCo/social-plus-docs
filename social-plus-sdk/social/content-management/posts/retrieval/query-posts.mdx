...
<CardGroup cols={2}>
  <Card icon="square-bolt" title="Live Collection">
    Query results are returned as live collections with real-time updates
  </Card>
  <Card icon="filter" title="Flexible Filtering">
