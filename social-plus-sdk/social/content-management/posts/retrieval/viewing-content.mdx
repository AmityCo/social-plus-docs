...
<Warning>
**Maximum Size**: 1 GB per image. For more information about image handling, please refer to [Image Handling](/social-plus-sdk/core-concepts/content-handling/image-handling).
</Warning>
...
<Info>
For more information about file handling, please refer to [File Handling](/social-plus-sdk/core-concepts/content-handling/file).
</Info>
...
<Info>
For more information about video handling, please refer to [Video Handling](/social-plus-sdk/core-concepts/content-handling/video-handling).
</Info>
...
<Info>
For more information about polls, please refer to [Poll Management](/social-plus-sdk/core-concepts/content-handling/poll-handling).
</Info>
