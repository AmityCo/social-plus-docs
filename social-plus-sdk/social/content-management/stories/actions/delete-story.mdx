---
title: "Delete Story"
description: "Delete stories using StoryRepository.softDeleteStory() or StoryRepository.hardDeleteStory(). Hard delete is permanent and cannot be undone."
---

Use `StoryRepository.softDeleteStory(storyId)` to mark a story as deleted while preserving its data, or `StoryRepository.hardDeleteStory(storyId)` to permanently remove a story and all associated data including reactions, comments, and analytics.
