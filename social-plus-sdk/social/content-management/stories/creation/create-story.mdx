import StoryCreateVideo from '/snippets/social-plus-sdk/social/story_create_video.mdx';
import StoryCreateImage from '/snippets/social-plus-sdk/social/story_create_image.mdx';
import StoryCreate from '/snippets/social-plus-sdk/social/story-create.mdx';
import StoryHyperlink from '/snippets/social-plus-sdk/social/story-hyperlink.mdx';
import GetStoryRepository from '/snippets/social-plus-sdk/social/get-story-repository.mdx';
import InitStoryRepository from '/snippets/social-plus-sdk/social/init-story-repository.mdx';
import CreateStoryImage from '/snippets/social-plus-sdk/social/create-story-image.mdx';
import CreateStoryVideo from '/snippets/social-plus-sdk/social/create-story-video.mdx';
...
import StorySoftDeleteStory from '/snippets/social-plus-sdk/social/story-soft-delete-story.mdx';
import StoryGetStoriesByTargets from '/snippets/social-plus-sdk/social/story-get-stories-by-targets.mdx';
import StoryHardDeleteStory from '/snippets/social-plus-sdk/social/story-hard-delete-story.mdx';
import StoryGetActiveStories from '/snippets/social-plus-sdk/social/story-get-active-stories.mdx';
import StoryCreateImageStory from '/snippets/social-plus-sdk/social/story-create-image-story.mdx';
import StoryCreateVideoStory from '/snippets/social-plus-sdk/social/story-create-video-story.mdx';
import Create_video_story from '/snippets/social-plus-sdk/social/create_video_story.mdx';
import Create_image_story from '/snippets/social-plus-sdk/social/create_image_story.mdx';
import CreateImageStory from '/snippets/social/stories/create-image-story.mdx';
import CreateImageStoryNew from '/snippets/social-plus-sdk/social/create-image-story.mdx';
...
<StorySoftDeleteStory />

<StoryHardDeleteStory />

<StoryGetStoriesByTargets />
