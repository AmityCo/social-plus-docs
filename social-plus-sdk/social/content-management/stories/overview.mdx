...
description: "Create ephemeral image and video stories in communities. Supports files up to 1GB (image) or 2GB/90s (video), interactive hyperlinks, and view analytics."
---

Use the Stories API to create, retrieve, and delete time-limited content in community targets. Stories support image and video formats, interactive hyperlinks with URL validation, and analytics for views, reach, and click-through rates.
...
<Info>
Stories support configurable expiry periods, **interactive hyperlinks** with URL whitelist validation, and analytics including views, reach, and click-through rates.
</Info>
