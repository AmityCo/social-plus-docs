...
description: "Flag or unflag posts and comments with 9 flag reasons including a custom 'Others' option. Flagged content appears in the Admin Console."
---

Use the flagging API to let users report posts and comments for moderator review. Supports 8 predefined flag reasons (harassment, spam, violence, sexual content, etc.) and a custom "Others" reason up to 300 characters. Flagged content appears in the social.plus Admin Console for review and action.

<CardGroup cols={2}>
  <Card title="Multi-Content Support" icon="flag">
    Flag both posts and comments with the same flagging API
  </Card>
