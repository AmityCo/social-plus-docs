...
| Self-harm or suicide | `ContentFlagReasonEnum.SelfHarmOrSuicide` | `.SelfHarmOrSuicide` | `AmityContentFlagReason.SelfHarmOrSuicide` | Reason enum exists; post/comment flag builders do not accept it |
| Violence or threatening content | `ContentFlagReasonEnum.ViolenceOrThreateningContent` | `.ViolenceOrThreateningContent` | `AmityContentFlagReason.ViolenceOrThreateningContent` | Reason enum exists; post/comment flag builders do not accept it |
| Selling and promoting restricted items | `ContentFlagReasonEnum.SellingAndPromotingRestrictedItems` | `.SellingAndPromotingRestrictedItems` | `AmityContentFlagReason.SellingAndPromotingRestrictedItems` | Reason enum exists; post/comment flag builders do not accept it |
| Sexual content or nudity | `ContentFlagReasonEnum.SexualContentOrNudity` | `.SexualContentOrNudity` | `AmityContentFlagReason.SexualContentOrNudity` | Reason enum exists; post/comment flag builders do not accept it |
...
| False information or misinformation | `ContentFlagReasonEnum.FalseInformationOrMisinformation` | `.FalseInformationOrMisinformation` | `AmityContentFlagReason.FalseInformationOrMisinformation` | Reason enum exists; post/comment flag builders do not accept it |
