import ClientGetShareableLinkConfiguration from '/snippets/social-plus-sdk/getting-started/client-get-shareable-link-configuration.mdx';
import ClientRenewWithAccessToken from '/snippets/social-plus-sdk/getting-started/client-renew-with-access-token.mdx';
import ClientValidateAccessToken from '/snippets/social-plus-sdk/getting-started/client-validate-access-token.mdx';
import ClientLoginWithAccessToken from '/snippets/social-plus-sdk/getting-started/client-login-with-access-token.mdx';
import ClientObserveSessionState from '/snippets/social-plus-sdk/getting-started/client-observe-session-state.mdx';
import ClientIsConnected from '/snippets/social-plus-sdk/getting-started/client-is-connected.mdx';
import Authentication from '/snippets/social-plus-sdk/getting-started/authentication.mdx';
import ClientCreate from '/snippets/social-plus-sdk/getting-started/client-create.mdx';
import ClientSetupLoginSubscriptions from '/snippets/social-plus-sdk/getting-started/client-setup-login-subscriptions.mdx';
import ClientLogin from '/snippets/social-plus-sdk/getting-started/client-login.mdx';
import ClientValidateTexts from '/snippets/social-plus-sdk/getting-started/client-validate-texts.mdx';
import ClientTerminate from '/snippets/social-plus-sdk/getting-started/client-terminate.mdx';
import ClientGetChatSettings from '/snippets/social-plus-sdk/getting-started/client-get-chat-settings.mdx';
import ClientRenewTokenWithHandler from '/snippets/social-plus-sdk/getting-started/client-renew-token-with-handler.mdx';
import ClientLogout from '/snippets/social-plus-sdk/getting-started/client-logout.mdx';
import ClientGetSocialSettings from '/snippets/social-plus-sdk/getting-started/client-get-social-settings.mdx';
import ClientIsSameUserId from '/snippets/social-plus-sdk/getting-started/client-is-same-user-id.mdx';
import ClientLoginAsBot from '/snippets/social-plus-sdk/getting-started/client-login-as-bot.mdx';
import ClientGetPresenceSetting from '/snippets/social-plus-sdk/getting-started/client-get-presence-setting.mdx';
import ClientGetToken from '/snippets/social-plus-sdk/getting-started/client-get-token.mdx';
import ClientIsExpired from '/snippets/social-plus-sdk/getting-started/client-is-expired.mdx';
import ClientMarkerSync from '/snippets/social-plus-sdk/getting-started/client-marker-sync.mdx';
import ClientGetProductCatalogueSetting from '/snippets/social-plus-sdk/getting-started/client-get-product-catalogue-setting.mdx';
import ClientValidateUrls from '/snippets/social-plus-sdk/getting-started/client-validate-urls.mdx';
import ClientRenewAccessToken from '/snippets/social-plus-sdk/getting-started/client-renew-access-token.mdx';
import ClientGetVisitorToken from '/snippets/social-plus-sdk/getting-started/client-get-visitor-token.mdx';
import ClientResumeSession from '/snippets/social-plus-sdk/getting-started/client-resume-session.mdx';
import ClientIsValidStateChange from '/snippets/social-plus-sdk/getting-started/client-is-valid-state-change.mdx';
import ClientGetLinkPreviewMetadata from '/snippets/social-plus-sdk/getting-started/client-get-link-preview-metadata.mdx';
import ClientGetActive from '/snippets/social-plus-sdk/getting-started/client-get-active.mdx';
import ClientGetCurrentUserType from '/snippets/social-plus-sdk/getting-started/client-get-current-user-type.mdx';
import ClientGetFeedSettings from '/snippets/social-plus-sdk/getting-started/client-get-feed-settings.mdx';
import ClientSecureLogout from '/snippets/social-plus-sdk/getting-started/client-secure-logout.mdx';
import ClientGetBotToken from '/snippets/social-plus-sdk/getting-started/client-get-bot-token.mdx';
import ConnectSdk from '/snippets/social-plus-sdk/getting-started/connect_sdk.mdx';
import InitializeAmitySdk from '/snippets/social-plus-sdk/getting-started/initialize_amity_sdk.mdx';
import DisconnectSdk from '/snippets/social-plus-sdk/getting-started/disconnect-sdk.mdx';
import Login from '/snippets/social-plus-sdk/getting-started/login.mdx';
import UserToken from '/snippets/social-plus-sdk/getting-started/user-token.mdx';
import SdkDisconnect from '/snippets/social-plus-sdk/getting-started/sdk-disconnect.mdx';
import SdkConnect from '/snippets/social-plus-sdk/getting-started/sdk-connect.mdx';
import SetupSdk from '/snippets/social-plus-sdk/getting-started/setup-sdk.mdx';
import CreateUser from '/snippets/social-plus-sdk/getting-started/create-user.mdx';
import NetworkSetting from '/snippets/social-plus-sdk/getting-started/network-setting.mdx';
import LogoutSdk from '/snippets/social-plus-sdk/getting-started/logout-sdk.mdx';
import LoginSdk from '/snippets/social-plus-sdk/getting-started/login-sdk.mdx';
import NetworkSettingsGet from '/snippets/social-plus-sdk/getting-started/network-settings-get.mdx';
import SdkInitialization from '/snippets/social-plus-sdk/getting-started/sdk-initialization.mdx';
import SessionHandler from '/snippets/social-plus-sdk/getting-started/session-handler.mdx';
import NetworkSettingsSetup from '/snippets/social-plus-sdk/getting-started/network-settings-setup.mdx';
import NetworkSettingsUpdate from '/snippets/social-plus-sdk/getting-started/network-settings-update.mdx';
import ClientObserveConnection from '/snippets/social-plus-sdk/getting-started/client-observe-connection.mdx';
import ClientDisconnect from '/snippets/social-plus-sdk/getting-started/client-disconnect.mdx';
import ObserveConnectionStatus from '/snippets/social-plus-sdk/getting-started/observe-connection-status.mdx';
import ClientConnect from '/snippets/social-plus-sdk/getting-started/client-connect.mdx';
import ReadSessionState from '/snippets/social-plus-sdk/getting-started/read-session-state.mdx';
import UserSessionHandler from '/snippets/social-plus-sdk/getting-started/user-session-handler.mdx';
import Logout from '/snippets/social-plus-sdk/getting-started/logout.mdx';
import ObserveSessionState from '/snippets/social-plus-sdk/getting-started/observe-session-state.mdx';
import EncryptionKeyGeneration from '/snippets/social-plus-sdk/getting-started/encryption-key-generation.mdx';
import Initializer from '/snippets/social-plus-sdk/getting-started/initializer.mdx';
import NetworkActivityLogging from '/snippets/social-plus-sdk/getting-started/network-activity-logging.mdx';
import InitializerWithDbEncryption from '/snippets/social-plus-sdk/getting-started/initializer-with-db-encryption.mdx';
import SecureLogout from '/snippets/social-plus-sdk/getting-started/secure-logout.mdx';
import Disconnection from '/snippets/social-plus-sdk/getting-started/disconnection.mdx';
import InitializerWithCustomEndPoint from '/snippets/social-plus-sdk/getting-started/initializer-with-custom-end-point.mdx';
import ClientCurrentUserId from '/snippets/social-plus-sdk/getting-started/client-current-user-id.mdx';
import ClientNotificationTray from '/snippets/social-plus-sdk/getting-started/client-notification-tray.mdx';
import ClientAccessToken from '/snippets/social-plus-sdk/getting-started/client-access-token.mdx';
import ClientLoginMethod from '/snippets/social-plus-sdk/getting-started/client-login-method.mdx';
import ClientMentionConfigurations from '/snippets/social-plus-sdk/getting-started/client-mention-configurations.mdx';
...
import Observe_session_state from '/snippets/social-plus-sdk/getting-started/observe_session_state.mdx';
import My_session_handler from '/snippets/social-plus-sdk/getting-started/my_session_handler.mdx';
import Renewal_with_auth_token from '/snippets/social-plus-sdk/getting-started/renewal_with_auth_token.mdx';
import MyView from '/snippets/social-plus-sdk/getting-started/my-view.mdx';
import ClientGetLoginMethod from '/snippets/social-plus-sdk/getting-started/client-get-login-method.mdx';
import ClientReadSessionState from '/snippets/social-plus-sdk/getting-started/client-read-session-state.mdx';
import ClientSetAccessTokenHandler from '/snippets/social-plus-sdk/getting-started/client-set-access-token-handler.mdx';
import ClientFetchLinkPreview from '/snippets/social-plus-sdk/getting-started/client-fetch-link-preview.mdx';
import ProductGet from '/snippets/social-plus-sdk/getting-started/product-get.mdx';
import CoreValidateTexts from '/snippets/social-plus-sdk/getting-started/core-validate-texts.mdx';
import ClientObserveNetworkActivities from '/snippets/social-plus-sdk/getting-started/client-observe-network-activities.mdx';
import ClientSendCustomCommandRequest from '/snippets/social-plus-sdk/getting-started/client-send-custom-command-request.mdx';
import CoreGetUserId from '/snippets/social-plus-sdk/getting-started/core-get-user-id.mdx';
import CoreObserveSessionState from '/snippets/social-plus-sdk/getting-started/core-observe-session-state.mdx';
import CoreIsUserLoggedIn from '/snippets/social-plus-sdk/getting-started/core-is-user-logged-in.mdx';
import ClientGetVisitorDeviceId from '/snippets/social-plus-sdk/getting-started/client-get-visitor-device-id.mdx';
import CoreValidateUrls from '/snippets/social-plus-sdk/getting-started/core-validate-urls.mdx';
import ClientSendCustomCommand from '/snippets/social-plus-sdk/getting-started/client-send-custom-command.mdx';
...
<ClientFetchLinkPreview />

### Step 3: Check Authentication Status

Verify if a user is currently logged in:

<ClientSetAccessTokenHandler />
...
<NetworkSettingsSetup />

<NetworkSettingsUpdate />

<ClientObserveConnection />
...
<InitializerWithDbEncryption />

<SecureLogout />

<Disconnection />

<InitializerWithCustomEndPoint />

<ClientCurrentUserId />

<ClientNotificationTray />

<ClientAccessToken />

<ClientLoginMethod />

<ClientMentionConfigurations />
...
<ClientGetLoginMethod />

<CoreValidateTexts />

<ClientObserveNetworkActivities />

<ClientSendCustomCommandRequest />

<CoreGetUserId />

<CoreObserveSessionState />

<CoreIsUserLoggedIn />

<ClientGetVisitorDeviceId />

<CoreValidateUrls />

<ClientSendCustomCommand />

<ClientGetShareableLinkConfiguration />

<ClientRenewWithAccessToken />

<ClientValidateAccessToken />

<ClientLoginWithAccessToken />
...
<ClientSetupLoginSubscriptions />

<ClientValidateTexts />

<ClientTerminate />

<ClientGetChatSettings />

<ClientRenewTokenWithHandler />

<ClientLogout />

<ClientGetSocialSettings />

<ClientIsSameUserId />

<ClientLoginAsBot />

<ClientGetPresenceSetting />
...
<ClientGetProductCatalogueSetting />

<ClientValidateUrls />

<ClientRenewAccessToken />

<ClientGetVisitorToken />

<ClientResumeSession />

<ClientIsValidStateChange />

<ClientGetLinkPreviewMetadata />

<ClientGetActive />

<ClientGetCurrentUserType />

<ClientGetFeedSettings />
