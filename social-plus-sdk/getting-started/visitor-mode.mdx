...
After secure mode is enabled for your network, retrieve your visitor application secret from the Console:
...
Scroll to the **Visitor Secure Mode Setup** section (visible only after secure mode is enabled)
</Step>
