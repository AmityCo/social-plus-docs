...
description: "Install Social+ SDK and start building social features in minutes. Follow our straightforward setup guide."
---

Ready to add powerful social features to your app? This guide will get you up and running with Social+ SDK quickly, whether you're building for mobile, web, or cross-platform.

<Note>
**New to Social+ SDK?** Check out our [SDK Overview](/social-plus-sdk/overview) to learn about all available features and choose what's right for your project.
</Note>
...
- [iOS SDK](/social-plus-sdk/getting-started/platform-setup/mobile/install-ios)
- [Android SDK](/social-plus-sdk/getting-started/platform-setup/mobile/install-android)
- [Flutter SDK](/social-plus-sdk/getting-started/platform-setup/mobile/install-flutter)
- [React Native SDK](/social-plus-sdk/getting-started/platform-setup/cross-platform/install-react-native)
</Card>

<Card title="Web" icon="globe">
- [TypeScript SDK](/social-plus-sdk/getting-started/platform-setup/web/install-web)
</Card>
</CardGroup>
