...
Modern TypeScript SDK with full type safety and framework support, including React Native compatibility.
</Card>
...
<Info>
For React Native setup and compatibility, see our <a href="/social-plus-sdk/getting-started/platform-setup/cross-platform/install-react-native">React Native installation guide</a>.
</Info>
