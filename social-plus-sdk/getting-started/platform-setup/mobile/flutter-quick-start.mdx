---
title: "Flutter"
description: "Get up and running with Social+ Flutter SDK for cross-platform applications in minutes."
---

Get your Flutter app connected to Social+ in just a few steps. This guide covers everything from installation to your first authenticated session.
