...
<!-- doc-as-test: skip(build-script: Gradle DSL fragment, not runtime Kotlin) -->
...
<!-- doc-as-test: skip(android: uses EncryptedSharedPreferences/MasterKeys not in compile classpath) -->
```kotlin
...
<!-- doc-as-test: skip(android-ui: Application class body, not standalone function) -->
```kotlin
