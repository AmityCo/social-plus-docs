...
description: "Get up and running with social.plus UIKit in minutes"
icon: "rocket"
---
...
<Note>
  **Prerequisites**: Review your platform guide ([iOS](/uikit/platform-guides/ios-specific), [Android](/uikit/platform-guides/android-specific), [Web](/uikit/platform-guides/web-specific), [React Native](/uikit/platform-guides/react-native-specific), [Flutter](/uikit/platform-guides/flutter-specific)) and complete [authentication setup](/uikit/getting-started/authentication).
</Note>
...
<Note>
Need brand colors only? Jump to <a href="/uikit/customization/theming-basics">Theming Basics</a>. Want to tweak a specific feed button/icon? Use <a href="/uikit/customization/component-styling">Component Styling</a>. Conditional layouts (e.g., hide creation for viewers) → <a href="/uikit/customization/dynamic-ui">Dynamic UI</a>. Completely new feed UX → <a href="/uikit/customization/advanced-customization">Fork & Extend</a>.
</Note>
...
<AccordionGroup>
  ...
  - Review the relevant [platform guide](/uikit/platform-guides/ios-specific) for platform-specific tips
