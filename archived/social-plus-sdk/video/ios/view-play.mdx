...
This framework requires `MobileVLCKit.framework` as a dependency. See the iOS setup notes in the [Getting Started Guide](/social-plus-sdk/getting-started/overview#ios) for installation context; then add `MobileVLCKit.framework` to your project.
