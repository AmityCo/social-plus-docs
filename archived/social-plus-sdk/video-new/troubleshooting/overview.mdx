...
- Core Concept References: [Streaming Basics](../core-concepts/streaming-basics), [Lifecycle Management](../core-concepts/lifecycle-management), [Permissions](../core-concepts/permissions)
