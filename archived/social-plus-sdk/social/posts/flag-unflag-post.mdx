    ...
    class PostFlaggingManager {
      ...
      async flagPost(
        ...
        try {
          ...
          console.log('Amity.Post flagged successfully');
          return true;
        } catch (error) {
      ...
      async isFlaggedByMe(postId: string): Promise<boolean> {
        try {
          ...
          console.log(`Amity.Post flagged by current user: ${isFlagged}`);
          return isFlagged;
        } catch (error) {
      ...
      async unflagPost(postId: string): Promise<boolean> {
        try {
          ...
          console.log('Amity.Post unflagged successfully');
          return true;
        } catch (error) {
      ...
      async toggleFlag(
        postId: string,
        reason: Amity.ContentFlagReason = ContentFlagReason.Others,
        explanation?: string
      ): Promise<boolean> {
      ...
      async flagPostWithValidation(
        ...
        try {
          ...
          if (alreadyFlagged) {
            return {
              success: false,
              message: 'Amity.Post is already flagged by you'
            };
          }
          ...
          return {
            success: true,
            message: 'Amity.Post flagged successfully'
          };
        } catch (error) {
          return {
            success: false,
