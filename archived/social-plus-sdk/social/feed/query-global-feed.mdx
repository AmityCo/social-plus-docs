  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      class GlobalFeedManager {
          ...
          private handleFeedUpdate(posts: Amity.Post[]): void {
      ...
      class AdvancedGlobalFeedManager {
          ...
          private handleFeedUpdate(posts: Amity.Post[], hasNextPage: boolean): void {
              console.log(`Global feed loaded with ${posts.length} posts, hasNext: ${hasNextPage}`);
          }
          
          private handleMorePosts(posts: Amity.Post[], hasNextPage: boolean): void {
              console.log(`Loaded ${posts.length} more posts, hasNext: ${hasNextPage}`);
          }
          
          private handleRealtimeUpdate(posts: Amity.Post[], changeType: string): void {
  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      class CustomRankingFeedManager {
          ...
          private handleRankedFeedUpdate(posts: Amity.Post[]): void {
      ...
      class QueryAllPostsManager {
          ...
          private processAnalytics(posts: Amity.Post[]): void {
              this.analyticsData = {
          ...
          private calculateAverageEngagement(posts: Amity.Post[]): number {
          ...
          private calculateEngagementDistribution(posts: Amity.Post[]): Record<string, number> {
          ...
          private handleQueryAllPostsResult(posts: Amity.Post[], hasNextPage: boolean): void {
...
<CardGroup cols={3}>
  <Card title="Custom Post Ranking" icon="star" href="./custom-post-ranking">
    Learn about the intelligent ranking algorithm and configuration options
  </Card>
  
  <Card title="Feed Overview" icon="home" href="./">
    Understand the different feed types and basic concepts
  </Card>
  
  <Card title="Posts Query" icon="file-text" href="/social-plus-sdk/social/content-management/posts/retrieval/query-posts">
...
<CodeGroup>
  ...
  class GlobalFeedWithRanking {
      ...
      async queryGlobalFeedWithRanking(options: RankingQueryOptions): Promise<Amity.Post[]> {
          try {
              const posts = await this.postRepository.queryAllPosts({
                  customRanking: true,
                  limit: options.limit || 20,
      ...
      private handleRankedPosts(posts: Amity.Post[]): void {
          console.log(`Retrieved ${posts.length} ranked posts`);
          // Posts are sorted by engagement score
      }
