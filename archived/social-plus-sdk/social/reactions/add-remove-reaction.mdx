...
<Tabs>
  ...
  <Tab title="Android">
    <CodeGroup>
      ...
      class ReactionManager(private val client: Client) {
      ...
      class AdvancedReactionManager(private val client: Client) {
          private val reactionRepository = AmityReactionRepository(client)
  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      class ReactionManager {
          ...
          async addReaction(
              ...
              try {
                  ...
                  console.log(`Amity.Reaction '${reactionName}' added successfully`);
          ...
          private trackReactionAdded(
              ...
              if (typeof window !== 'undefined' && window.analytics) {
                  window.analytics.track('Amity.Reaction Added', {
                      reactionName,
                      referenceType,
                      timestamp: Date.now()
                  });
      ...
      interface UseReactionResult {
          addReaction: (reactionName: string, referenceType: ReactionReferenceType, referenceId: string) => Promise<Amity.Reaction>;
      ...
      export const useReaction = (): UseReactionResult => {
          ...
          const validateReactionInput = (
              ...
              if (!reactionName || reactionName.length === 0) {
                  throw new Error('Amity.Reaction name cannot be empty');
              }
              if (reactionName.length > 100) {
                  throw new Error('Amity.Reaction name cannot exceed 100 characters');
              }
              if (!referenceId) {
              ...
              if (reactionCache.has(reactionKey)) {
                  throw new Error('Amity.Reaction already exists');
              }
          };
      ...
      class ReactionManager {
          ...
          async removeReaction(
              ...
              try {
                  ...
                  console.log(`Amity.Reaction '${reactionName}' removed successfully`);
      ...
      class AdvancedReactionManager {
          ...
          async removeReactionWithStateManagement(
              ...
              if (!this.state.reactions.has(reactionKey)) {
                  throw new Error(`Amity.Reaction '${reactionName}' not found`);
              }
