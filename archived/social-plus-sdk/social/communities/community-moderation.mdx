...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    async function addRolesToMembers(
      ...
      try {
        await CommunityRepository.Moderation.addRoles(communityId, userIds, roles);
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    async function removeRolesFromMembers(
      ...
      try {
        await CommunityRepository.Moderation.removeRoles(communityId, userIds, roles);
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    async function removeMembersFromCommunity(
      ...
      try {
        await CommunityRepository.Membership.removeMembers(communityId, userIds);
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    function checkCommunityPermission(
      ...
      return /* Permission checking was removed in v6 — enforcement is server-side. Check SDK release notes. */;
    }
