...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    // Get specific category by ID
    async function getCategory(categoryId: string): Promise<Amity.Category | null> {
      try {
        const category = await CategoryRepository.getCategory(categoryId);
        
        console.log('Amity.Category Name:', category.name);
        console.log('Amity.Category ID:', category.categoryId);
    ...
    // Handle category data
    function handleCategory(category: Amity.Category) {
      // Update UI with category information
      displayCategoryInfo(category);
    ...
    async function queryAllCategories() {
      try {
        ...
        categories.forEach(category => {
          console.log(`Amity.Category: ${category.name}`);
        });
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ```typescript
    function displayCategoryDetails(category: Amity.Category) {
      // Basic information
...
async function trackCategoryPopularity() {
  ...
  console.log('Amity.Category Popularity:', popularityData);
