  ...
  <Tab title="TypeScript">
    ...
    async function updateCommunityBasics(
      ...
      try {
        ...
        console.log('Amity.Community updated successfully');
    ...
    async function updateCommunityPrivacy(
      ...
      try {
        ...
        console.log(`Amity.Community is now ${visibility}`);
  ...
  <Tab title="TypeScript">
    ...
    async function updatePostSettings(
      ...
      try {
        ...
        console.log('Amity.Post settings updated:', community.postSettings);
    ...
    async function updateCommunityComprehensive(
      ...
      try {
        ...
        console.log('Amity.Community updated comprehensively');
        refreshCommunityUI(community);
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ```typescript
    // Check if user can update community
    function canUpdateCommunity(community: Amity.Community): boolean {
