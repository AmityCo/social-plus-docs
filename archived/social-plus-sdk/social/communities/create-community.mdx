  ...
  CommunityRepository
    ...
    async function createBasicCommunity() {
      try {
        ...
        console.log('Amity.Community ID:', community.communityId);
      } catch (error) {
    ...
    async function createAdvancedCommunity() {
      ...
      try {
        const params: CreateCommunityParams = {
          ...
          description: 'Amity.Community for TypeScript developers to share knowledge',
          isPublic: false, // Private community
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    try {
      ...
      // Amity.Community created successfully
      console.log('Amity.Community ID:', community.communityId);
