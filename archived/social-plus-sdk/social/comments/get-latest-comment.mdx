...
<Note>
  Refer to [Comment Data Structure](./README.mdx#comment-data-structure) for detailed information about comment properties and [Live Objects](/social-plus-sdk/core-concepts/realtime-communication/live-objects-collections/overview) for real-time update patterns.
</Note>
...
- [Real-time Events](/social-plus-sdk/core-concepts/realtime-communication/realtime-events/overview) - Event subscription patterns
- [Live Objects](/social-plus-sdk/core-concepts/realtime-communication/live-objects-collections/overview) - Real-time data handling