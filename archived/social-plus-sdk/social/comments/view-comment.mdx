...
<Note>
  For comprehensive comment interaction features, see [Comment Reactions](./get-comment-reaction-data.mdx) and [Reply to Comments](./create-comment.mdx#reply-comments). For advanced rendering customization, refer to [UI Kit Components](/uikit/overview).
</Note>
...
- [UI Kit Components](/uikit/overview) - Pre-built comment UI components