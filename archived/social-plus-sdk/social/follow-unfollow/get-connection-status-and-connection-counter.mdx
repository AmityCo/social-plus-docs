  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      class MyFollowInfoManager {
          ...
          private displayMyFollowInfo(followInfo: Amity.FollowInfo): void {
      ...
      export const useMyFollowInfo = () => {
          const [followInfo, setFollowInfo] = useState<Amity.FollowInfo | null>(null);
...
<Tabs>
  ...
  <Tab title="TypeScript">
    <CodeGroup>
      ...
      private displayUserFollowInfo(followInfo: Amity.FollowInfo, userId: string): void {
