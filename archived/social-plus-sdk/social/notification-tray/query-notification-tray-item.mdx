  ...
  notificationTray
    ...
    class NotificationQueryManager {
        ...
        setupBasicQuery() {
            ...
            const liveCollection = notificationTray.getNotificationTrayItems(query);
...
<Tabs>
  <Tab title="Load More Pattern">
    ...
    class NotificationListManager {
        private notifications: Amity.NotificationTrayItem[] = [];
        private liveCollection: any;
        private isLoading = false;
        private readonly LOAD_MORE_THRESHOLD = 5;
        
        constructor(private onUpdate: (notifications: Amity.NotificationTrayItem[]) => void) {}
        ...
        getNotifications(): Amity.NotificationTrayItem[] {
  ...
  <Tab title="React Hook Implementation">
    ...
    export const useNotificationQuery = ({ query, autoLoad = true }: UseNotificationQueryOptions) => {
        const [notifications, setNotifications] = useState<Amity.NotificationTrayItem[]>([]);
        ...
        const loadNotifications = useCallback(async () => {
            ...
            try {
                const collection = notificationTray.getNotificationTrayItems(query);
