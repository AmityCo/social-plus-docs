  ...
  <Step title="Initialize Repository">
    ...
    <Tabs>
      ...
      <Tab title="Web">
        ...
        // Access notification tray methods directly via the notificationTray namespace
        const items = notificationTray.getNotificationTrayItems({});
        ```
      </Tab>
    </Tabs>
  </Step>
    ...
    <Tabs>
      ...
      <Tab title="Android">
        ...
        private fun markTrayAsSeen() {
            notificationRepository.markTraySeen()
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe({
      ...
      <Tab title="Web">
        ...
        async function markTrayAsSeen() {
            try {
                await notificationRepository.markTraySeen();
