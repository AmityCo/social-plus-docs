  ...
  <Tab title="Web">
    <CodeGroup>
      ...
      class NotificationItemComponent {
          private notificationItem: Amity.NotificationTrayItem;
          
          constructor(item: Amity.NotificationTrayItem) {
      ...
      interface NotificationItemProps {
          ...
          onItemClick: (item: Amity.NotificationTrayItem) => void;
      }
      ...
      interface UseNotificationInteractionResult {
          markItemSeen: (item: Amity.NotificationTrayItem) => Promise<void>;
          isMarking: boolean;
          error: Error | null;
      }
      ...
      export const useNotificationInteraction = (): UseNotificationInteractionResult => {
          ...
          const markItemSeen = useCallback(async (item: Amity.NotificationTrayItem) => {
              setIsMarking(true);
              setError(null);
    ...
    <Tabs>
      ...
      <Tab title="Web">
        <CodeGroup>
          ```typescript
          class NotificationAnalytics {
              static trackNotificationInteraction(item: Amity.NotificationTrayItem): void {
                  const properties = {
                      notification_id: item.notificationId,
                      action_type: item.actionType,
                      target_type: item.targetType,
              ...
              private static calculateTimeToInteraction(item: Amity.NotificationTrayItem): number {
      ...
      <Tab title="Web">
        <CodeGroup>
          ...
          class NotificationItemErrorHandler {
              ...
              private async showRetryOption(item: Amity.NotificationTrayItem): Promise<boolean> {
