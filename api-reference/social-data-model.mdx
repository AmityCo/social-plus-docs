...
<AccordionGroup>
  ...
  <Accordion title="Post" icon="file-lines">
    ...
    | `sharedCount`           | integer   | **Reserved / not implemented.** Placeholder for an in-app reshare feature that does not exist; always `0`. For sharing content, use [shareable links](/social-plus-sdk/social/content-management/content-sharing). |
