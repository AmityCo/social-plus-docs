...
<Tabs>
  ...
  <Tab title="React Native">
    ...
    **Simple Integration:**
    ...
    <Note>
      `AmityUiKitChat` is the only chat entry point the package exports. Chat screens — conversation, group settings, search, archive — are reached by navigating from the chat list; they can't be imported and rendered individually. See [Chat Components](/uikit/components/chat/overview) for what's included.
    </Note>
