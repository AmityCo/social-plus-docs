...
<Tabs>
 ...
 <Tab title="Web (React)">
    ...
    *Reference: [PNPM Installation Guide](https://pnpm.io/installation#using-corepack)*
    ...
    ```jsx
    import React from 'react';
    import { AmityUIKitProvider, AmitySocialUIKit } from '@amityco/ui-kit-react';
    // Import styles from your forked version
    import './amity-uikit/styles/index.css';
    ...
    ### Build Configuration
    **Webpack/Vite Configuration for Custom Builds:**
    ```javascript
    // webpack.config.js or vite.config.js
    export default {
      resolve: {
        alias: {
          '@amityco/ui-kit-react': path.resolve(__dirname, 'src/amity-uikit')
        }
      },
      // Additional configuration for TypeScript and CSS processing
      module: {
        rules: [
          {
            test: /\.tsx?$/,
    ...
    <Tabs>
      ...
      <Tab title="Git Submodule">
        **Add as submodule:**
        ...
        git submodule add https://github.com/YOUR_USERNAME/Amity-Social-Cloud-UIKit-Flutter-OpenSource.git packages/amity_uikit
        git submodule update --init --recursive
        ```
    ...
    *Android (android/app/build.gradle):*
    ...
    void main() async {
      ...
      await AmityUIKit.setup(
        apikey: "YOUR_API_KEY",
        region: AmityRegion.US,  // US, EU, or SG
      );
