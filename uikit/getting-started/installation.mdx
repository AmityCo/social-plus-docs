...
<Tabs>
  ...
  <Tab title="React Native">
    ...
    yarn add @amityco/ts-sdk-react-native@7.27.0 react-native-fs@2.20.0 @livekit/react-native @livekit/react-native-webrtc livekit-client @react-native-firebase/app @react-native-firebase/messaging @react-native-async-storage/async-storage @react-native-clipboard/clipboard @react-native-community/datetimepicker @react-native-community/netinfo @react-navigation/native @react-navigation/native-stack @react-navigation/stack react-native-compressor react-native-gesture-handler react-native-get-random-values react-native-haptic-feedback react-native-image-picker react-native-linear-gradient react-native-safe-area-context react-native-screens react-native-svg react-native-video react-native-video-controls react-native-vision-camera @babel/plugin-transform-export-namespace-from
    ...
    <Note>
      `@amityco/ts-sdk-react-native` and `react-native-fs` are pinned to exact versions. Installing a different version of either is unsupported.
    </Note>

    ### Configure Babel

    Installing `@babel/plugin-transform-export-namespace-from` is not enough — register it in your app's `babel.config.js`, or the build fails:
