...
<Tabs>
  <Tab title="iOS">
    ...
    **2. Create an Xcode Workspace, and then add both MyApp.xcodeproj and AmityUIKit.xcodeproj together under the same workspace.**
    ...
    <img src="/images/ios-opensource-directory.png" alt="iOS Open Source Project Directory Structure" />

    <div align="center">
      <img src="/images/ios-opensource-xcode-workspace-project-structure.png" alt="Xcode Workspace Project Structure" />
    </div>
    ...
    **3. AmityUIKit links with other dependencies such as AmitySDK, Realm etc through SharedFrameworks which is a Swift Package.**
    ...
    - **3.2 Link SharedFrameworks & AmityUIKit.framework to YourApp.xcodeproj target as shown below.**
      ...
      <img src="/images/ios-opensource-link-framework.png" alt="Link SharedFrameworks to iOS Project" />

      <img src="/images/ios-opensource-link-framework-2.png" alt="Link AmityUIKit Framework to iOS Project" />
    ...
    **4. On MyApp.xcodeproj, let's try importing social.plus UIKit / social.plus SDK and call some APIs. You should be able to compile and run the app.**
    ...
    <img src="/images/ios-opensource-integration-example.png" alt="iOS Integration Example" />
