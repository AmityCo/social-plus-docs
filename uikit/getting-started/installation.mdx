...
<Tabs>
  <Tab title="iOS">
    ...
    ```
    ### Presenting UIKit Pages After Device Registration
    Once the device has been successfully registered, you can start presenting UIKit components in your application.

    For example, to open the Social Home Page, you can initialize the component and present it using AmitySwiftUIHostingController:
    ```swift
    ...
    You can follow the same pattern to present other UIKit components — simply initialize the desired component and wrap it inside AmitySwiftUIHostingController.

    For a full list of available components and detailed usage instructions, please refer to our [official documentation.](https://learn.social.plus/uikit/components/overview)
  ...
  <Tab title="Web (React)">
    ...
    import { AmityUiKitProvider, AmityUiKitSocial } from '@amityco/ui-kit-react';
  ...
  <Tab title="Flutter">
    <Info>
      **Flutter UIKit is only available through GitHub forking** - no package installation option available.
    </Info>
  </Tab>
  <Tab title="React Native (Beta)">
   ...
   ### Installation
    ...
    ```bash
    npm i @amityco/react-native-social-uikit
    ```
    ...
    **Install PNPM (Optional but Recommended):**
    ...
    <Tabs>
      <Tab title="Project Integration">
        ...
        **Step 6: Navigate to Your Application**

        ```bash
        cd <path-to-your-app>
        ```

        **Step 7: Link UIKit to Your Application** Choose your preferred package manager:
    ...
    <Tabs>
      <Tab title="Local Path Dependency">
        ...
        **Example App Reference:**
        ...
        The repository includes a working sample app that illustrates how UIKit is initialized and used within a Flutter project.
        This example project demonstrates:
          -	Basic UIKit initialization
          -	Authentication setup
          -	Core UI components usage
          -	Navigation integration
          -	Configuration patterns

        To run the example:
         ```bash
        cd Amity-Social-UIKit-Flutter-Opensource/example
        flutter pub get
        flutter run
        ```
        Recommended to review this sample app to understand how the UI components are tied together.
      </Tab>
