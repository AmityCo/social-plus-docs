...
<Tabs>
  ...
  <Tab title="React Native">
    ...
    <Accordion title="Building from source instead" icon="code-branch">
      To customize the UIKit itself, work from the open-source repository rather than the published package:

      1. Fork the [React Native UIKit repository](https://github.com/AmityCo/Amity-Social-UIKit-React-Native-CLI-OpenSource) and clone your fork.
      2. Build a local package and install it into your app:

      ```bash
      cd Amity-Social-UIKit-React-Native-CLI-OpenSource
      yarn install
      npm pack        # produces amity-react-native-social-ui-kit-x.x.x.tgz

      # from your app
      yarn add ../path/to/amity-react-native-social-ui-kit-x.x.x.tgz
      ```

      Install the same peer dependencies listed above.
    </Accordion>
...
<Warning>
  **Note**: The Flutter UIKit is only available through GitHub forking, not
  package installation. React Native is published on npm — see the React Native
  tab under [Package Installation](#package-installation).
</Warning>
...
<Tabs>
  ...
  <Tab title="React Native">
    React Native UIKit is published on npm, so most apps should use the [Package Installation](#package-installation) steps. To customize the UIKit source, fork the [React Native UIKit repository](https://github.com/AmityCo/Amity-Social-UIKit-React-Native-CLI-OpenSource) and follow **Building from source instead** in the React Native tab of Package Installation.
  </Tab>
</Tabs>
