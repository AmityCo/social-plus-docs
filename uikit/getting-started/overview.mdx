  ...
  <Step title="Choose Your Platform">
    ...
    <CardGroup cols={2}>
      <Card title="Native Mobile" icon="mobile">
        - [iOS Platform Guide](/uikit/platform-guides/ios-specific) 
        - [Android Platform Guide](/uikit/platform-guides/android-specific)
      </Card>

      <Card title="Cross-Platform & Web" icon="globe">
        - [React Web Guide](/uikit/platform-guides/web-specific)
        - [React Native Guide](/uikit/platform-guides/react-native-specific)
        - [Flutter Guide](/uikit/platform-guides/flutter-specific)
      </Card>
    </CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Platform Guides" icon="wrench" href="/uikit/platform-guides/ios-specific">
    Platform-specific tips & advanced setup
  </Card>
