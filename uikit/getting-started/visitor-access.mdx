...
<CardGroup cols={2}>
<Card title="Default Page" icon="circle-exclamation">
- Warning icon
- Title: *"You've reached your daily limit."*
- Subtitle: *"Create an account or sign in to keep exploring the community."*
- "Sign in" CTA button
- Toast: *"Create an account or sign in to continue."* (3s auto-dismiss)
</Card>
<Card title="Navigation is Blocked" icon="ban">
...
<CardGroup cols={2}>
  <Card title="SDK Visitor Mode" href="/social-plus-sdk/getting-started/visitor-mode" icon="key">
    Visitor login, device fingerprinting, secure mode, and SDK error codes
  </Card>
  <Card title="Error Handling" href="/social-plus-sdk/core-concepts/foundation/logging" icon="triangle-exclamation">
