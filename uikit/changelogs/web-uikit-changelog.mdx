...
<Update label="4.18.0  (03/07/2026)" tags={["New Releases","Improvements"]}>
  ...
  Introduced the chat experience, bringing the refreshed component architecture to messaging.
  ...
  ## 🐞 Bug Fixes
  - Fixed non-members incorrectly seeing a "join community" toast when reporting a post.
