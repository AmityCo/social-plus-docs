...
<Update label="4.3.0  (25/09/2026)" tags={["New Releases","Improvements"]}>
  ...
  Handle avatar and @mention taps in your own app through `AmityChatPageBehavior` and `AmityMessageBubbleBehavior`. See [Message Bubble Behavior](/uikit/components/chat/conversation-chat#message-bubble-behavior).
