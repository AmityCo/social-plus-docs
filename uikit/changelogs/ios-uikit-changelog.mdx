...
<Update label="4.22.0 (05/06/2026)" tags={["New Releases", "Improvements"]}>
  ...
  #### Manual Post Hiding
  Added the ability for users to manually hide posts from their feed.

  #### Visitor Usage Limit Page
  Added `AmityVisitorUsageLimitPage` — a full-screen error shown when a visitor exceeds their daily read quota (error `400323`). The page shows a "Sign in" CTA and is presented modally with swipe-back and back-button disabled. Two new `AmityGlobalBehavior` overrides let you customise the experience:
  ...
  - Fixed visitor usage limit observer not re-subscribing after an environment change.
  - Fixed multiple regression issues across feed, comment, and post flows.
...
<Update label="4.18.3-xcode26.4.1 (24/04/2026)" tags={["New Releases", "Improvements"]}>
  ...
  26.4.1 =\> 4.18.3-xcode26.4.1
  26.4 =\> 4.18.3-xcode26.4
  26.3 =\> 4.18.3-xcode26.3
