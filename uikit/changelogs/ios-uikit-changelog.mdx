...
<Update label="4.22.0 (05/06/2026)" tags={["New Releases", "Improvements"]}>
  ...
  - Improved visitor usage limit handling — the publisher now re-subscribes correctly when the environment changes.

  ## 🐞 Bug Fixes

  - Fixed visitor usage limit error states not being handled gracefully.
