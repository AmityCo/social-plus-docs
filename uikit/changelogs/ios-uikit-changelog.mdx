...
<Update label="4.26.2  (18/08/2026)" tags={["Improvements"]}>
  ...
  - Fixed a batch of reported issues, including image loading (`AsyncImage`), the notification tray item, and the comment composer, plus assorted page refinements.
