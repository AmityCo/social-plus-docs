...
<Info>
**Message-level moderation**: Moderator deletion of another member's message is separate from member-level actions such as banning, muting, removing, or changing roles. It is available from iOS UIKit **4.23.0**, Android UIKit **4.23.0**, and Web (React) UIKit **4.20.0**.
</Info>
