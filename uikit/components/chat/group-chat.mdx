...
<Info>
**Platform Support**: Group Chat components are available on **iOS, Android, React, React Native, and Flutter**. On **React Native** (v4.3.0+), these screens are part of the chat experience mounted by `AmityUiKitChat`; they aren't exported individually, so the component examples below don't apply — see [Installation](/uikit/getting-started/installation#add-chat).
</Info>
