...
<Tabs>
  ...
  <Tab title="Message Components">
    **Individual message rendering and composition**
    ...
    Override `AmityMessageBubbleBehavior` to route taps on a sender's **avatar** and on a **mentioned user** to your own screens. The mention-user tap override is available on iOS (UIKit 4.28.0) and Android (UIKit 4.26.0); the default does nothing until you override it.
