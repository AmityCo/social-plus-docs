...
<Info>
**Message-level moderation**: Moderator deletion of another member's message is separate from member-level actions such as banning, muting, removing, or changing roles. It is available on Android UIKit **4.23.0** and Web UIKit **4.20.0**.
</Info>
...
<Tabs>
  ...
  <Tab title="Group Settings & Administration">
    **Group management and configuration**
    ...
    | Message Moderation         | Moderators can delete other members' messages (Android 4.23.0; Web 4.20.0) |
  ...
  <Tab title="Moderation & Reporting">
    **Safety and content management tools**
    ...
    Group moderators can delete messages authored by other members on Android UIKit **4.23.0** and Web UIKit **4.20.0**. This is a message-level moderation action and is separate from member-level ban, mute, removal, and role-management actions.
