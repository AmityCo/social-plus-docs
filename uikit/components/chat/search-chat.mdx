...
<Info>
**Platform Support**: Chat Search is available on **Flutter** (standalone `AmitySearchChannelPage`), **React Web**, and **React Native** v4.3.0+ (both reached from the chat home page — see the notes below). Refer to the platform UIKit for iOS and Android availability.
</Info>
