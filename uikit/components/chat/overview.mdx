...
description: "Complete guide to Social+ UIKit chat components for building messaging experiences"
---

# Chat Components

Social+ UIKit provides a comprehensive set of chat components for building modern messaging experiences. These components are designed to work seamlessly across all platforms with consistent functionality and customizable styling.
...
<Steps>
  <Step title="Initialize Chat">
    Set up the chat client with your Social+ credentials
  </Step>
...
<Steps>
  <Step title="Authentication">
    User authenticates with Social+ credentials
  </Step>
