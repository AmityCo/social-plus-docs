...
<CardGroup cols={3}>
  <Card title="Conversation Chat" href="/uikit/components/chat/conversation-chat" icon="comments">
    **Individual Chats**
    Navigate to specific conversation interfaces
  </Card>
  <Card title="User Search" href="/uikit/components/chat/user-search" icon="search">
    **Find Users**
    Search and discover users for new conversations
  </Card>
  <Card title="Chat Settings" href="/uikit/components/chat/chat-settings" icon="gear">
    **Configuration**
    Manage chat preferences and settings
  </Card>
</CardGroup>
