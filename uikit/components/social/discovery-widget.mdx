...
<Note>
The component is named `AmityDiscoveryWidgetComponent` on **Web**. On **iOS** and **Android** it is still `AmityContentWidgetComponent` — the rename has not reached those platforms yet.
</Note>
