...
<Tabs>
  ...
  <Tab title="Multiple Reactions">
    ...
    **Global Configuration**: These reaction configurations are set at the global level in AmityUIKitConfig.json and apply across all UIKit components automatically.
    ...
    Configure reactions specifically for social posts and comments. For React UIKit, you need to upload images to your static folder, and the configuration should specify the filename with its extension and include the relative path if the image is in a subfolder:
    ...
    ```json React UIKit
    {
      "social_reactions": [
        {
          "name": "like",
          "image": "messageReactionLike.png"
        },
        {
          "name": "love",
          "image": "messageReactionHeart.png"
        },
        {
          "name": "fire",
          "image": "messageReactionFire.png"
        },
        {
          "name": "happy",
          "image": "messageReactionGrinning.png"
        },
        {
          "name": "sad",
          "image": "messageReactionSad.png"
        }
      ]
    }
    ```
    ...
    Configure reactions specifically for direct messages and chat. For React UIKit, you need to upload images to your static folder, and the configuration should specify the filename with its extension and include the relative path if the image is in a subfolder:
