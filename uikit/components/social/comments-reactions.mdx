...
<Tabs>
  ...
  <Tab title="Multiple Reactions">
    ...
    **Global Configuration**: These reaction configurations are set at the global level in AmityUIKitConfig.json and apply across all UIKit components automatically.
    ...
    Configure reactions specifically for social posts and comments. For React UIKit, you have to upload images to static folder, and the configuration will be the path of the image:
    ...
    Configure reactions specifically for direct messages and chat. For React UIKit, you have to upload images to static folder, and the configuration will be the path of the image:
