import Update_current_user from '/snippets/uikit/components/update_current_user.mdx';
import Query_users from '/snippets/uikit/components/query_users.mdx';
import Create_user_repository from '/snippets/uikit/components/create_user_repository.mdx';
import Update_user_avatar from '/snippets/uikit/components/update_user_avatar.mdx';
import Observe_user from '/snippets/uikit/components/observe_user.mdx';
import Search_users_partial from '/snippets/uikit/components/search_users_partial.mdx';
import Search_users from '/snippets/uikit/components/search_users.mdx';
import Update_user_custom_avatar from '/snippets/uikit/components/update_user_custom_avatar.mdx';
---
title: "Users"
...
<Tabs>
  <Tab title="User Profiles & Display">
    **User profile pages and feed components for displaying user information and content**
    ...
    <Info>
    **SDK Integration**: This component uses the [Get User Feed API](/social-plus-sdk/social/feed/get-user-feed) to query user posts with configurable feed sources. Refer to the API documentation for detailed implementation and privacy rules.
    </Info>
