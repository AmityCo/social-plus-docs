...
| Localization key (Web) | Default |
| --- | --- |
| `amity_livechat_pinned_message_pin_button` | Pin message |
| `amity_livechat_pinned_message_unpin_button` | Unpin message |
| `amity_livechat_pinned_message_badge` | Pinned |
| `amity_livechat_pinned_message_more` | more |
| `amity_livechat_pinned_message_less` | less |
