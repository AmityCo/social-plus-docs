...
| Role | Pin from the ⋮ menu | Unpin (banner "X", and the ⋮ menu on Android) | Sees the banner |
| --- | --- | --- | --- |
| Host | ✅ | ✅ | ✅ |
| Co-host | ✅ | ✅ | ✅ |
...
- **Unpin.** The "X" on the banner unpins, and is shown only to users who can pin. **On Android**, the ⋮ menu of the pinned message also offers **Unpin message** in place of **Pin message**. iOS and Web offer the banner "X" only.
...
| `livestream_chat_feed/*/unpin_message_button` | Element | Customize or exclude the unpin control. On iOS and Web this is the "X" on the banner. On Android it is both the "X" and the ⋮ menu's "Unpin message" item |
...
| Unpin message | "Unpin message" on Android's ⋮ menu item; the banner "X" is icon-only on every platform | `amity_livechat_pinned_message_unpin_button` |
