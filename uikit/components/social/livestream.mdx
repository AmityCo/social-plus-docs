...
| Viewer navigates elsewhere in-app    | Any navigation that opens another page floats the stream, including a destination your app supplies through the product-tag behavior override |
...
| Condition                          | Behavior                                                                                                     |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| Deliberate exit                    | Closing the player or pressing back stops playback — no window opens                                          |
...
| PiP disabled in device settings    | No window opens and **no error is shown** — playback simply stops. See [The Device PiP Setting](#the-device-pip-setting) |
...
| Stream ends while floating           | Playback stops in the window straight away; the ended, terminated or unavailable screen appears when the viewer expands  |
