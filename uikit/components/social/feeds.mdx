...
<CardGroup cols={2}>
  <Card title="Content Feeds" icon="newspaper">
    **Dynamic Social Streams**
    ...
    - [For You](#for-you-feed) — backend-personalized feed
...
<Tabs>
  ...
  <Tab title="Feed Components">
    **Newsfeed and content display**
    ...
    | --- | --- |
    | Newsfeed | Stories plus the global post list |
    | Global Feed | Aggregated community posts |
    | [For You Feed](#for-you-feed) | Backend-personalized posts, gated on a network setting |
