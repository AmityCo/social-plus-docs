...
<CardGroup cols={2}>
  <Card title="Text & Media Posts" icon="pen-to-square">
    **Rich Content Creation**
    - Text posts with **optional post titles** for better organization
    - **Free-form hashtag support** for content discovery and categorization
    - Multiple image and video attachments per post
    - Media attachment workflows with accessibility features
    - **User community posts** displayed on personal feeds
  </Card>
  <Card title="Interactive Polls" icon="chart-bar">
    **Polling & Voting**
    - Text-based polls with multiple choice options
    - **Image polls** with visual voting experiences
    - **Poll vote management** - users can change or remove their votes
    - Multiple selection support 
    - Customizable poll duration settings
  </Card>
</CardGroup>

<CardGroup cols={2}>
  <Card title="Post Management" icon="folder-grid">
    **Content Management**
    - Post editing capabilities for all content types
    - Content detail views with **inline comments under posts**
    - Real-time engagement tracking (reactions, comments, views)
    - Comprehensive moderation tools
  </Card>
  <Card title="Advanced Features" icon="sparkles">
    **Enhanced Interactions**
    - @Mention functionality with user notifications
    - **Shareable deep links** for posts
    - Automatic link preview generation
    - **Community gallery media linked to original posts** for context
    - Brand user support for professional accounts
  </Card>
</CardGroup>
