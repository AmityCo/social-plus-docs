...
<Tabs>
  ...
  <Tab title="Post Composer">
    **Create and edit posts**
    ...
    <Note>
    The composer body shows **placeholder text** when empty. Customize it by overriding the localization string `amity_social_placeholder_post_composer_body_placeholder` rather than through a config element. The reaction label color on a post follows the theme's base color, so it recolors with your theme.
    </Note>
