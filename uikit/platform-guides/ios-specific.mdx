...
description: "Advanced iOS-specific features, optimizations, and best practices for Social+ UIKit"
icon: "apple"
---

# iOS Platform Guide

This guide covers iOS-specific features, optimizations, and advanced configurations for Social+ UIKit. For basic installation, see our [Installation Guide](/uikit/getting-started/installation#ios).
