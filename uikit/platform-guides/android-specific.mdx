...
description: "Advanced Android-specific features, optimizations, and best practices for Social+ UIKit"
icon: "android"
---

# Android Platform Guide

This guide covers Android-specific features, optimizations, and advanced configurations for Social+ UIKit. For basic installation, see our [Installation Guide](/uikit/getting-started/installation#android).
