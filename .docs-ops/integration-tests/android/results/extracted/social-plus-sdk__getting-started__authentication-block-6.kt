// source: social-plus-sdk/getting-started/authentication.mdx:569-582
    ...
    amityImage: AmityImage? = null
        ...
        class ProductionSessionHandler : SessionHandler {
            override fun sessionWillRenewAccessToken(renewal: AccessTokenRenewal) {
                // Call your backend to refresh token; renewal.renewWithAuthToken(newToken)
                // or renewal.unableToRetrieveAuthToken() on failure
            }
        }

        // Use during login
        val productionSessionHandler = ProductionSessionHandler()
        AmityCoreClient.login(userId = userId, sessionHandler = productionSessionHandler)
