// source: social-plus-sdk/social/content-management/posts/retrieval/query-posts.mdx:188-227
...
fun docSnippet(
    ...
    fun queryPostsWithTags(postRepository: AmityPostRepository, tags: List<String>) {
        //User's Media Gallery Example
        //For this use-case:
        //  - Search all the "image" and "video" posts - Belong to the user "steven".
        //  - Only non-deleted posts.
        ...
        postRepository
            .getPosts()
            .targetUser(userId = "steven")
            .tags(tags = tags)  // For example: listOf("product","promotion")
            .types(postTypes = listOf(AmityPost.DataType.IMAGE, AmityPost.DataType.VIDEO))
            .includeDeleted(includeDeleted = false)
            .sortBy(sortOption = AmityUserFeedSortOption.LAST_CREATED)
            .build()
