// source: social-plus-sdk/social/content-management/posts/moderation/edit-post.mdx:130-149
...
fun docSnippet(
    ...
    fun updateTextPost(post: AmityPost, postRepository: AmityPostRepository) {
        val links = listOf(
          AmityLink(
            index = 18,
            length = 20,
        ...
        postRepository.editPost(postId = post.getPostId())
          .text(text = "Updated text with https://www.amity.co")
          .links(links)
          .build()
          .apply()
          .subscribe()
