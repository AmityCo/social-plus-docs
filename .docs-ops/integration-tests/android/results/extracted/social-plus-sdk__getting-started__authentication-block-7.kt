// source: social-plus-sdk/getting-started/authentication.mdx:744-766
    ...
    amityImage: AmityImage? = null
        ...
        val handler = object : AccessTokenHandler {
          override suspend fun onTokenRenew(userId: String): String {
            // get new token from your api; replace with real API call
        ...
        AmityCoreClient.loginWithAccessToken(authToken)
          .build()
          .submit()
          .subscribe()
}
