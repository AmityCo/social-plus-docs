// source: social-plus-sdk/social/content-management/posts/retrieval/query-posts.mdx:447-461
...
fun docSnippet(
    ...
    amityImage: AmityImage? = null
        ...
        // Query community posts from the last 7 days only
        val oneWeekAgo = org.joda.time.DateTime().minusDays(7)
