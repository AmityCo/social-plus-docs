...
<div className="hero-section">
  ...
  <Card title="Admin Portal" icon="building" href="/analytics-and-moderation/social+-portal/README">
      Manage apps, regions, billing, usage, and account settings from one centralized platform.
    </Card>
    <Card title="Admin Console & Moderation" icon="shield-plus" href="/analytics-and-moderation/console/overview/">
      Monitor data, configure settings, and manage moderation across your social.plus applications.
    </Card>
    <Card title="Analytics Dashboard" icon="chart-simple" href="/analytics-and-moderation/social+-portal/dashboard/README">
