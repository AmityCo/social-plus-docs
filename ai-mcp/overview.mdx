...
<CardGroup cols={3}>
  ...
  <Card title="Cursor" icon="cursor-arrow" href="/ai-mcp/cursor">
...
<CardGroup cols={2}>
  ...
  <Card title="Posts" icon="message-square" href="/social-plus-sdk/social/content-management/posts/overview">
