...
<Frame>
  <img src="/images/ai-mcp/agentry-connect-flow.svg" alt="Three steps: install Social Plus Agentry from your AI app's directory, authorize with a connect code, then ask" />
</Frame>
