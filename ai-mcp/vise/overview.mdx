...
<Frame>
  <img src="/images/ai-mcp/vise-demo.svg" alt="Vise guiding a coding agent: plan from docs, checks for SDK usage, lifecycle, completeness and project validation, ending in an honest handoff" />
</Frame>
...
<Info>
  Vise runs locally and does not upload your source code, file contents, or search queries. The hosted [docs MCP server](/ai-mcp/docs-mcp-server) is different: it helps assistants search the documentation, while Vise guides and validates work inside your project.
</Info>
